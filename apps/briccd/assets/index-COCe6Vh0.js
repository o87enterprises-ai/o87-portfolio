...
void main() {
	...
	`}var So=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,Zc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Ci(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Fi({vertexShader:Yc,fragmentShader:Xc,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Jr(new Ei(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Qc=class extends et{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,f=null,p=null,m=null,h=typeof XRWebGLBinding<`u`,_=new Zc,v={},y=t.getContextAttributes(),b=null,S=null,C=[],w=[],T=new K,k=null,A=new ma;A.viewport=new Ut;let j=new ma;j.viewport=new Ut;let M=[A,j],N=new Sa,P=null,F=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new Tn,C[e]=t),t.getHandSpace()};function I(e){let t=w.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ee(){r.removeEventListener(`select`,I),r.removeEventListener(`selectstart`,I),r.removeEventListener(`selectend`,I),r.removeEventListener(`squeeze`,I),r.removeEventListener(`squeezestart`,I),r.removeEventListener(`squeezeend`,I),r.removeEventListener(`end`,ee),r.removeEventListener(`inputsourceschange`,te);for(let e=0;e<C.length;e++){let t=w[e];t!==null&&(w[e]=null,C[e].disconnect(t))}P=null,F=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(b),p=null,f=null,u=null,r=null,S=null,ce.stop(),n.isPresenting=!1,e.setPixelRatio(k),e.setSize(T.width,T.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&H(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&H(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return u===null&&h&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return m},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(b=e.getRenderTarget(),r.addEventListener(`select`,I),r.addEventListener(`selectstart`,I),r.addEventListener(`selectend`,I),r.addEventListener(`squeeze`,I),r.addEventListener(`squeezestart`,I),r.addEventListener(`squeezeend`,I),r.addEventListener(`end`,ee),r.addEventListener(`inputsourceschange`,te),y.xrCompatible!==!0&&await t.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(T),h&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;y.depth&&(o=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=y.stencil?O:D,a=y.stencil?x:g);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),f=u.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Gt(f.textureWidth,f.textureHeight,{format:E,type:d,depthTexture:new xi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Gt(p.framebufferWidth,p.framebufferHeight,{format:E,type:d,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),ce.setContext(r),ce.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function te(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=w.indexOf(n);r>=0&&(w[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=w.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=w.length){w.push(n),r=e;break}else if(w[e]===null){w[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let ne=new q,re=new q;function L(e,t,n){ne.setFromMatrixPosition(t.matrixWorld),re.setFromMatrixPosition(n.matrixWorld);let r=ne.distanceTo(re),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ie(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),N.near=j.near=A.near=t,N.far=j.far=A.far=n,(P!==N.near||F!==N.far)&&(r.updateRenderState({depthNear:N.near,depthFar:N.far}),P=N.near,F=N.far),N.layers.mask=e.layers.mask|6,A.layers.mask=N.layers.mask&-5,j.layers.mask=N.layers.mask&-3;let i=e.parent,a=N.cameras;ie(N,i);for(let e=0;e<a.length;e++)ie(a[e],i);a.length===2?L(N,A,j):N.projectionMatrix.copy(A.projectionMatrix),ae(e,N,i)};function ae(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=rt*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(N)},this.getCameraTexture=function(e){return v[e]};let oe=null;function se(t,i){if(l=i.getViewerPose(c||a),m=i,l!==null){let t=l.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==N.cameras.length&&(N.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=u.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=M[n];o===void 0&&(o=new ma,o.layers.enable(n),o.viewport=new Ut,M[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(N.matrix.copy(o.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),i===!0&&N.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&h){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&h){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Ci,v[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=w[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}oe&&oe(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),m=null}let ce=new Wa;ce.setAnimationLoop(se),this.setAnimationLoop=function(e){oe=e},this.dispose=function(){}}},$c=new Jt,el=new J;el.set(-1,0,0,0,1,0,0,0,1);function tl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,ji(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4($c.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(el),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function nl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return U(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):ArrayBuffer.isView(o)?i.__data.set(new o.constructor(o.buffer,o.byteOffset,i.__data.length)):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?H(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):H(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var rl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),il=null;function al(){return il===null&&(il=new Zr(rl,16,16,j,v),il.name=`DFG_LUT`,il.minFilter=c,il.magFilter=c,il.wrapS=r,il.wrapT=r,il.generateMipmaps=!1,il.needsUpdate=!0),il}var ol=class{constructor(e={}){let{canvas:t=Ke(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:p=!1,outputBufferType:h=d}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);_=n.getContextAttributes().alpha}else _=a;let S=h,C=new Set([N,M,A]),w=new Set([d,g,m,x,y,b]),T=new Uint32Array(4),E=new Int32Array(4),D=new q,O=null,k=null,j=[],P=[],F=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let I=this,ee=!1,te=null;this._outputColorSpace=Ie;let ne=0,re=0,L=null,ie=-1,ae=null,oe=new Ut,se=new Ut,ce=null,le=new X(0),ue=0,de=t.width,fe=t.height,pe=1,me=null,he=null,ge=new Ut(0,0,de,fe),_e=new Ut(0,0,de,fe),ve=!1,ye=new ai,be=!1,xe=!1,Se=new Jt,Ce=new q,we=new Ut,Te={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ee=!1;function De(){return L===null?pe:1}let R=n;function Oe(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:f};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r184`),t.addEventListener(`webglcontextlost`,tt,!1),t.addEventListener(`webglcontextrestored`,nt,!1),t.addEventListener(`webglcontextcreationerror`,rt,!1),R===null){let t=`webgl2`;if(R=Oe(t,e),R===null)throw Oe(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw U(`WebGLRenderer: `+e.message),e}let ke,Ae,z,je,B,V,Me,Ne,Pe,Fe,Le,Re,ze,Be,Ve,Ue,We,Ge,qe,Je,Xe,Ze,$e;function et(){ke=new wo(R),ke.init(),Xe=new Jc(R,ke),Ae=new $a(R,ke,e,Xe),z=new Kc(R,ke),Ae.reversedDepthBuffer&&p&&z.buffers.depth.setReversed(!0),je=new Do(R),B=new Ec,V=new qc(R,ke,z,B,Ae,Xe,je),Me=new Co(I),Ne=new Ga(R),Ze=new Za(R,Ne),Pe=new To(R,Ne,je,Ze),Fe=new ko(R,Pe,Ne,Ze,je),Ge=new Oo(R,Ae,V),Ve=new eo(B),Le=new Tc(I,Me,ke,Ae,Ze,Ve),Re=new tl(I,B),ze=new Ac,Be=new Lc(ke),We=new Xa(I,Me,z,Fe,_,s),Ue=new Gc(I,Fe,Ae),$e=new nl(R,je,Ae,z),qe=new Qa(R,ke,je),Je=new Eo(R,ke,je),je.programs=Le.programs,I.capabilities=Ae,I.extensions=ke,I.properties=B,I.renderLists=ze,I.shadowMap=Ue,I.state=z,I.info=je}et(),S!==1009&&(F=new jo(S,t.width,t.height,r,i));let W=new Qc(I,R);this.xr=W,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){let e=ke.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=ke.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return pe},this.setPixelRatio=function(e){e!==void 0&&(pe=e,this.setSize(de,fe,!1))},this.getSize=function(e){return e.set(de,fe)},this.setSize=function(e,n,r=!0){if(W.isPresenting){H(`WebGLRenderer: Can't change size while VR device is presenting.`);return}de=e,fe=n,t.width=Math.floor(e*pe),t.height=Math.floor(n*pe),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),F!==null&&F.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(de*pe,fe*pe).floor()},this.setDrawingBufferSize=function(e,n,r){de=e,fe=n,pe=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){U(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){H(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}F.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(oe)},this.getViewport=function(e){return e.copy(ge)},this.setViewport=function(e,t,n,r){e.isVector4?ge.set(e.x,e.y,e.z,e.w):ge.set(e,t,n,r),z.viewport(oe.copy(ge).multiplyScalar(pe).round())},this.getScissor=function(e){return e.copy(_e)},this.setScissor=function(e,t,n,r){e.isVector4?_e.set(e.x,e.y,e.z,e.w):_e.set(e,t,n,r),z.scissor(se.copy(_e).multiplyScalar(pe).round())},this.getScissorTest=function(){return ve},this.setScissorTest=function(e){z.setScissorTest(ve=e)},this.setOpaqueSort=function(e){me=e},this.setTransparentSort=function(e){he=e},this.getClearColor=function(e){return e.copy(We.getClearColor())},this.setClearColor=function(){We.setClearColor(...arguments)},this.getClearAlpha=function(){return We.getClearAlpha()},this.setClearAlpha=function(){We.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(L!==null){let t=L.texture.format;e=C.has(t)}if(e){let e=L.texture.type,t=w.has(e),n=We.getClearColor(),r=We.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,R.clearBufferuiv(R.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,R.clearBufferiv(R.COLOR,0,E))}else r|=R.COLOR_BUFFER_BIT}t&&(r|=R.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&R.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),te=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,tt,!1),t.removeEventListener(`webglcontextrestored`,nt,!1),t.removeEventListener(`webglcontextcreationerror`,rt,!1),We.dispose(),ze.dispose(),Be.dispose(),B.dispose(),Me.dispose(),Fe.dispose(),Ze.dispose(),$e.dispose(),Le.dispose(),W.dispose(),W.removeEventListener(`sessionstart`,lt),W.removeEventListener(`sessionend`,ut),dt.stop()};function tt(e){e.preventDefault(),Ye(`WebGLRenderer: Context Lost.`),ee=!0}function nt(){Ye(`WebGLRenderer: Context Restored.`),ee=!1;let e=je.autoReset,t=Ue.enabled,n=Ue.autoUpdate,r=Ue.needsUpdate,i=Ue.type;et(),je.autoReset=e,Ue.enabled=t,Ue.autoUpdate=n,Ue.needsUpdate=r,Ue.type=i}function rt(e){U(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function it(e){let t=e.target;t.removeEventListener(`dispose`,it),G(t)}function G(e){at(e),B.remove(e)}function at(e){let t=B.get(e).programs;t!==void 0&&(t.forEach(function(e){Le.releaseProgram(e)}),e.isShaderMaterial&&Le.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Te);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=xt(e,t,n,r,i);z.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Pe.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;Ze.setup(i,r,s,n,c);let h,g=qe;if(c!==null&&(h=Ne.get(c),g=Je,g.setIndex(h)),i.isMesh)r.wireframe===!0?(z.setLineWidth(r.wireframeLinewidth*De()),g.setMode(R.LINES)):g.setMode(R.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),z.setLineWidth(e*De()),i.isLineSegments?g.setMode(R.LINES):i.isLineLoop?g.setMode(R.LINE_LOOP):g.setMode(R.LINE_STRIP)}else i.isPoints?g.setMode(R.POINTS):i.isSprite&&g.setMode(R.TRIANGLES);if(i.isBatchedMesh)if(ke.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ne.get(c).bytesPerElement:1,o=B.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(R,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ot(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,_t(e,t,n),e.side=0,e.needsUpdate=!0,_t(e,t,n),e.side=2):_t(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Be.get(n),k.init(t),P.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ot(a,n,e),r.add(a)}else ot(t,n,e),r.add(t)}),k=P.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){B.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}ke.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let st=null;function ct(e){st&&st(e)}function lt(){dt.stop()}function ut(){dt.start()}let dt=new Wa;dt.setAnimationLoop(ct),typeof self<`u`&&dt.setContext(self),this.setAnimationLoop=function(e){st=e,W.setAnimationLoop(e),e===null?dt.stop():dt.start()},W.addEventListener(`sessionstart`,lt),W.addEventListener(`sessionend`,ut),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){U(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ee===!0)return;te!==null&&te.renderStart(e,t);let n=W.enabled===!0&&W.isPresenting===!0,r=F!==null&&(L===null||n)&&F.begin(I,L);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(F===null||F.isCompositing()===!1)&&(W.cameraAutoUpdate===!0&&W.updateCamera(t),t=W.getCamera()),e.isScene===!0&&e.onBeforeRender(I,e,t,L),k=Be.get(e,P.length),k.init(t),k.state.textureUnits=V.getTextureUnits(),P.push(k),Se.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),ye.setFromProjectionMatrix(Se,He,t.reversedDepth),xe=this.localClippingEnabled,be=Ve.init(this.clippingPlanes,xe),O=ze.get(e,j.length),O.init(),j.push(O),W.enabled===!0&&W.isPresenting===!0){let e=I.xr.getDepthSensingMesh();e!==null&&ft(e,t,-1/0,I.sortObjects)}ft(e,t,0,I.sortObjects),O.finish(),I.sortObjects===!0&&O.sort(me,he),Ee=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,Ee&&We.addToRenderList(O,e),this.info.render.frame++,be===!0&&Ve.beginShadows();let i=k.state.shadowsArray;if(Ue.render(i,e,t),be===!0&&Ve.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&F.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];mt(n,r,e,a)}Ee&&We.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];pt(O,e,n,n.viewport)}}else r.length>0&&mt(n,r,e,t),Ee&&We.render(e),pt(O,e,t)}L!==null&&re===0&&(V.updateMultisampleRenderTarget(L),V.updateRenderTargetMipmap(L)),r&&F.end(I),e.isScene===!0&&e.onAfterRender(I,e,t),Ze.resetDefaultState(),ie=-1,ae=null,P.pop(),P.length>0?(k=P[P.length-1],V.setTextureUnits(k.state.textureUnits),be===!0&&Ve.setGlobalState(I.clippingPlanes,k.state.camera)):k=null,j.pop(),O=j.length>0?j[j.length-1]:null,te!==null&&te.renderEnd()};function ft(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||ye.intersectsSprite(e)){r&&we.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Se);let t=Fe.update(e),i=e.material;i.visible&&O.push(e,t,i,n,we.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||ye.intersectsObject(e))){let t=Fe.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),we.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),we.copy(e.boundingSphere.center)),we.applyMatrix4(e.matrixWorld).applyMatrix4(Se)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,we.z,o)}}else i.visible&&O.push(e,t,i,n,we.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)ft(i[e],t,n,r)}function pt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),be===!0&&Ve.setGlobalState(I.clippingPlanes,n),r&&z.viewport(oe.copy(r)),i.length>0&&ht(i,t,n),a.length>0&&ht(a,t,n),o.length>0&&ht(o,t,n),z.buffers.depth.setTest(!0),z.buffers.depth.setMask(!0),z.buffers.color.setMask(!0),z.setPolygonOffset(!1)}function mt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=ke.has(`EXT_color_buffer_half_float`)||ke.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Gt(1,1,{generateMipmaps:!0,type:e?v:d,minFilter:u,samples:Math.max(4,Ae.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Y.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||oe;a.setSize(o.z*I.transmissionResolutionScale,o.w*I.transmissionResolutionScale);let s=I.getRenderTarget(),c=I.getActiveCubeFace(),l=I.getActiveMipmapLevel();I.setRenderTarget(a),I.getClearColor(le),ue=I.getClearAlpha(),ue<1&&I.setClearColor(16777215,.5),I.clear(),Ee&&We.render(n);let f=I.toneMapping;I.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),be===!0&&Ve.setGlobalState(I.clippingPlanes,r),ht(e,n,r),V.updateMultisampleRenderTarget(a),V.updateRenderTargetMipmap(a),ke.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,gt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(V.updateMultisampleRenderTarget(a),V.updateRenderTargetMipmap(a))}I.setRenderTarget(s,c,l),I.setClearColor(le,ue),p!==void 0&&(r.viewport=p),I.toneMapping=f}function ht(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&gt(o,t,n,s,l,c)}}function gt(e,t,n,r,i,a){e.onBeforeRender(I,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(I,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,I.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,I.renderBufferDirect(n,t,r,i,e,a),i.side=2):I.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(I,t,n,r,i,a)}function _t(e,t,n){t.isScene!==!0&&(t=Te);let r=B.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Le.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Le.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Me.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,it),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return yt(e,s),d}else s.uniforms=Le.getUniforms(e),te!==null&&e.isNodeMaterial&&te.build(e,n,s),e.onBeforeCompile(s,I),d=Le.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ve.uniform),yt(e,s),r.needsLights=Ct(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function vt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Rs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function yt(e,t){let n=B.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function bt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function xt(e,t,n,r,i){t.isScene!==!0&&(t=Te),V.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=L===null?I.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:Y.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Me.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(h=I.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=B.get(r),y=k.state.lights;if(be===!0&&(xe===!0||e!==ae)){let t=e===ae&&r.id===ie;Ve.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ve.numPlanes||v.numIntersection!==Ve.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=_t(r,t,i),te&&r.isNodeMaterial&&te.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(z.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ie&&(ie=r.id,C=!0),v.needsLights){let e=bt(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||ae!==e){z.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(R,`projectionMatrix`,e.projectionMatrix),T.setValue(R,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(R,Ce.setFromMatrixPosition(e.matrixWorld)),Ae.logarithmicDepthBuffer&&T.setValue(R,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(R,`isOrthographic`,e.isOrthographicCamera===!0),ae!==e&&(ae=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(R,`directionalShadowMap`,y.state.directionalShadowMap,V),y.state.spotShadowMap.length>0&&T.setValue(R,`spotShadowMap`,y.state.spotShadowMap,V),y.state.pointShadowMap.length>0&&T.setValue(R,`pointShadowMap`,y.state.pointShadowMap,V)),i.isSkinnedMesh){T.setOptional(R,i,`bindMatrix`),T.setOptional(R,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(R,`boneTexture`,e.boneTexture,V))}i.isBatchedMesh&&(T.setOptional(R,i,`batchingTexture`),T.setValue(R,`batchingTexture`,i._matricesTexture,V),T.setOptional(R,i,`batchingIdTexture`),T.setValue(R,`batchingIdTexture`,i._indirectTexture,V),T.setOptional(R,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(R,`batchingColorTexture`,i._colorsTexture,V));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ge.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(R,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=al()),C){if(T.setValue(R,`toneMappingExposure`,I.toneMappingExposure),v.needsLights&&St(E,w),a&&r.fog===!0&&Re.refreshFogUniforms(E,a),Re.refreshMaterialUniforms(E,r,pe,fe,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Rs.upload(R,vt(v),E,V)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Rs.upload(R,vt(v),E,V),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(R,`center`,i.center),T.setValue(R,`modelViewMatrix`,i.modelViewMatrix),T.setValue(R,`normalMatrix`,i.normalMatrix),T.setValue(R,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];$e.update(n,x),$e.bind(n,x)}}return x}function St(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Ct(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ne},this.getActiveMipmapLevel=function(){return re},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(e,t,n){let r=B.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),B.get(e.texture).__webglTexture=t,B.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=B.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let wt=R.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){L=e,ne=t,re=n;let r=null,i=!1,a=!1;if(e){let o=B.get(e);if(o.__useDefaultFramebuffer!==void 0){z.bindFramebuffer(R.FRAMEBUFFER,o.__webglFramebuffer),oe.copy(e.viewport),se.copy(e.scissor),ce=e.scissorTest,z.viewport(oe),z.scissor(se),z.setScissorTest(ce),ie=-1;return}else if(o.__webglFramebuffer===void 0)V.setupRenderTarget(e);else if(o.__hasExternalTextures)V.rebindTextures(e,B.get(e.texture).__webglTexture,B.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&B.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);V.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=B.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&V.useMultisampledRTT(e)===!1?B.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,oe.copy(e.viewport),se.copy(e.scissor),ce=e.scissorTest}else oe.copy(ge).multiplyScalar(pe).floor(),se.copy(_e).multiplyScalar(pe).floor(),ce=ve;if(n!==0&&(r=wt),z.bindFramebuffer(R.FRAMEBUFFER,r)&&z.drawBuffers(e,r),z.viewport(oe),z.scissor(se),z.setScissorTest(ce),i){let r=B.get(e.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=B.get(e.textures[t]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=B.get(e.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,t.__webglTexture,n)}ie=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){U(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=B.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){z.bindFramebuffer(R.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+s),!Ae.textureFormatReadable(c)){U(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ae.textureTypeReadable(l)){U(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&R.readPixels(t,n,r,i,Xe.convert(c),Xe.convert(l),a)}finally{let e=L===null?null:B.get(L).__webglFramebuffer;z.bindFramebuffer(R.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=B.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){z.bindFramebuffer(R.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+s),!Ae.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ae.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,d),R.bufferData(R.PIXEL_PACK_BUFFER,a.byteLength,R.STREAM_READ),R.readPixels(t,n,r,i,Xe.convert(l),Xe.convert(u),0);let f=L===null?null:B.get(L).__webglFramebuffer;z.bindFramebuffer(R.FRAMEBUFFER,f);let p=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await Qe(R,p,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,d),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,a),R.deleteBuffer(d),R.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;V.setTexture2D(e,0),R.copyTexSubImage2D(R.TEXTURE_2D,n,0,0,o,s,i,a),z.unbindTexture()};let Tt=R.createFramebuffer(),K=R.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=Xe.convert(t.format),_=Xe.convert(t.type),v;t.isData3DTexture?(V.setTexture3D(t,0),v=R.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(V.setTexture2DArray(t,0),v=R.TEXTURE_2D_ARRAY):(V.setTexture2D(t,0),v=R.TEXTURE_2D),z.activeTexture(R.TEXTURE0),z.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,t.flipY),z.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),z.pixelStorei(R.UNPACK_ALIGNMENT,t.unpackAlignment);let y=z.getParameter(R.UNPACK_ROW_LENGTH),b=z.getParameter(R.UNPACK_IMAGE_HEIGHT),x=z.getParameter(R.UNPACK_SKIP_PIXELS),S=z.getParameter(R.UNPACK_SKIP_ROWS),C=z.getParameter(R.UNPACK_SKIP_IMAGES);z.pixelStorei(R.UNPACK_ROW_LENGTH,h.width),z.pixelStorei(R.UNPACK_IMAGE_HEIGHT,h.height),z.pixelStorei(R.UNPACK_SKIP_PIXELS,l),z.pixelStorei(R.UNPACK_SKIP_ROWS,u),z.pixelStorei(R.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=B.get(e),r=B.get(t),h=B.get(n.__renderTarget),g=B.get(r.__renderTarget);z.bindFramebuffer(R.READ_FRAMEBUFFER,h.__webglFramebuffer),z.bindFramebuffer(R.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,B.get(e).__webglTexture,i,d+n),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,B.get(t).__webglTexture,a,m+n)),R.blitFramebuffer(l,u,o,s,f,p,o,s,R.DEPTH_BUFFER_BIT,R.NEAREST);z.bindFramebuffer(R.READ_FRAMEBUFFER,null),z.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||B.has(e)){let n=B.get(e),r=B.get(t);z.bindFramebuffer(R.READ_FRAMEBUFFER,Tt),z.bindFramebuffer(R.DRAW_FRAMEBUFFER,K);for(let e=0;e<c;e++)w?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,n.__webglTexture,i),T?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,r.__webglTexture,a),i===0?T?R.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):R.copyTexSubImage2D(v,a,f,p,l,u,o,s):R.blitFramebuffer(l,u,o,s,f,p,o,s,R.COLOR_BUFFER_BIT,R.NEAREST);z.bindFramebuffer(R.READ_FRAMEBUFFER,null),z.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?R.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?R.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):R.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):R.texSubImage2D(R.TEXTURE_2D,a,f,p,o,s,g,_,h);z.pixelStorei(R.UNPACK_ROW_LENGTH,y),z.pixelStorei(R.UNPACK_IMAGE_HEIGHT,b),z.pixelStorei(R.UNPACK_SKIP_PIXELS,x),z.pixelStorei(R.UNPACK_SKIP_ROWS,S),z.pixelStorei(R.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&R.generateMipmap(v),z.unbindTexture()},this.initRenderTarget=function(e){B.get(e).__webglFramebuffer===void 0&&V.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?V.setTextureCube(e,0):e.isData3DTexture?V.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?V.setTexture2DArray(e,0):V.setTexture2D(e,0),z.unbindTexture()},this.resetState=function(){ne=0,re=0,L=null,z.reset(),Ze.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return He}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Y._getDrawingBufferColorSpace(e),t.unpackColorSpace=Y._getUnpackColorSpace()}},sl={type:`change`},cl={type:`start`},ll={type:`end`},ul=new Fr,dl=new ti,fl=Math.cos(70*Tt.DEG2RAD),pl=new q,ml=2*Math.PI,hl={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},gl=1e-6,_l=class extends Va{constructor(n,r=null){super(n,r),this.state=hl.NONE,this.target=new q,this.cursor=new q,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new q,this._lastQuaternion=new Et,this._lastTargetPosition=new q,this._quat=new Et().setFromUnitVectors(n.up,new q(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new za,this._sphericalDelta=new za,this._scale=1,this._panOffset=new q,this._rotateStart=new K,this._rotateEnd=new K,this._rotateDelta=new K,this._panStart=new K,this._panEnd=new K,this._panDelta=new K,this._dollyStart=new K,this._dollyEnd=new K,this._dollyDelta=new K,this._dollyDirection=new q,this._mouse=new K,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=yl.bind(this),this._onPointerDown=vl.bind(this),this._onPointerUp=bl.bind(this),this._onContextMenu=Dl.bind(this),this._onMouseWheel=Cl.bind(this),this._onKeyDown=wl.bind(this),this._onTouchStart=Tl.bind(this),this._onTouchMove=El.bind(this),this._onMouseDown=xl.bind(this),this._onMouseMove=Sl.bind(this),this._interceptControlDown=Ol.bind(this),this._interceptControlUp=kl.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(sl),this.update(),this.state=hl.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;pl.copy(t).sub(this.target),pl.applyQuaternion(this._quat),this._spherical.setFromVector3(pl),this.autoRotate&&this.state===hl.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=ml:n>Math.PI&&(n-=ml),r<-Math.PI?r+=ml:r>Math.PI&&(r-=ml),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(pl.setFromSpherical(this._spherical),pl.applyQuaternion(this._quatInverse),t.copy(this.target).add(pl),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=pl.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new q(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new q(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=pl.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(ul.origin.copy(this.object.position),ul.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(ul.direction))<fl?this.object.lookAt(this.target):(dl.setFromNormalAndCoplanarPoint(this.object.up,this.target),ul.intersectPlane(dl,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>gl||8*(1-this._lastQuaternion.dot(this.object.quaternion))>gl||this._lastTargetPosition.distanceToSquared(this.target)>gl?(this.dispatchEvent(sl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?ml/60/60*this.autoRotateSpeed:ml/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){pl.setFromMatrixColumn(t,0),pl.multiplyScalar(-e),this._panOffset.add(pl)}_panUp(e,t){this.screenSpacePanning===!0?pl.setFromMatrixColumn(t,1):(pl.setFromMatrixColumn(t,0),pl.crossVectors(this.object.up,pl)),pl.multiplyScalar(e),this._panOffset.add(pl)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;pl.copy(r).sub(this.target);let i=pl.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(ml*this._rotateDelta.x/t.clientHeight),this._rotateUp(ml*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(ml*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-ml*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(ml*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-ml*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(ml*this._rotateDelta.x/t.clientHeight),this._rotateUp(ml*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new K,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function vl(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function yl(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function bl(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(ll),this.state=hl.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y});break}}function xl(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=hl.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=hl.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=hl.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=hl.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=hl.PAN}break;default:this.state=hl.NONE}this.state!==hl.NONE&&this.dispatchEvent(cl)}function Sl(e){switch(this.state){case hl.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case hl.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case hl.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e);break}}function Cl(e){this.enabled===!1||this.enableZoom===!1||this.state!==hl.NONE||(e.preventDefault(),this.dispatchEvent(cl),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(ll))}function wl(e){this.enabled!==!1&&this._handleKeyDown(e)}function Tl(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=hl.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=hl.TOUCH_PAN;break;default:this.state=hl.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=hl.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=hl.TOUCH_DOLLY_ROTATE;break;default:this.state=hl.NONE}break;default:this.state=hl.NONE}this.state!==hl.NONE&&this.dispatchEvent(cl)}function El(e){switch(this._trackPointer(e),this.state){case hl.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case hl.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case hl.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case hl.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=hl.NONE}}function Dl(e){this.enabled!==!1&&e.preventDefault()}function Ol(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function kl(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var Al=class e{static createButton(t,n={}){let r=document.createElement(`button`);function i(){let e=null;async function i(n){n.addEventListener(`end`,a),await t.xr.setSession(n),r.textContent=`EXIT VR`,e=n}function a(){e.removeEventListener(`end`,a),r.textContent=`ENTER VR`,e=null}r.style.display=``,r.style.cursor=`pointer`,r.style.left=`calc(50% - 50px)`,r.style.width=`100px`,r.textContent=`ENTER VR`;let o={...n,optionalFeatures:[`local-floor`,`bounded-floor`,`layers`,...n.optionalFeatures||[]]};r.onmouseenter=function(){r.style.opacity=`1.0`},r.onmouseleave=function(){r.style.opacity=`0.5`},r.onclick=function(){e===null?navigator.xr.requestSession(`immersive-vr`,o).then(i):(e.end(),navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)}))},navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)})}function a(){r.style.display=``,r.style.cursor=`auto`,r.style.left=`calc(50% - 75px)`,r.style.width=`150px`,r.onmouseenter=null,r.onmouseleave=null,r.onclick=null}function o(){a(),r.textContent=`VR NOT SUPPORTED`}function s(e){a(),console.warn(`Exception when trying to call xr.isSessionSupported`,e),r.textContent=`VR NOT ALLOWED`}function c(e){e.style.position=`absolute`,e.style.bottom=`20px`,e.style.padding=`12px 6px`,e.style.border=`1px solid #fff`,e.style.borderRadius=`4px`,e.style.background=`rgba(0,0,0,0.1)`,e.style.color=`#fff`,e.style.font=`normal 13px sans-serif`,e.style.textAlign=`center`,e.style.opacity=`0.5`,e.style.outline=`none`,e.style.zIndex=`999`}if(`xr`in navigator)return r.id=`VRButton`,r.style.display=`none`,c(r),navigator.xr.isSessionSupported(`immersive-vr`).then(function(t){t?i():o(),t&&e.xrSessionIsGranted&&r.click()}).catch(s),r;{let e=document.createElement(`a`);return window.isSecureContext===!1?(e.href=document.location.href.replace(/^http:/,`https:`),e.innerHTML=`WEBXR NEEDS HTTPS`):(e.href=`https://immersiveweb.dev/`,e.innerHTML=`WEBXR NOT AVAILABLE`),e.style.left=`calc(50% - 90px)`,e.style.width=`180px`,e.style.textDecoration=`none`,c(e),e}}static registerSessionGrantedListener(){if(typeof navigator<`u`&&`xr`in navigator){if(/WebXRViewer\//i.test(navigator.userAgent))return;navigator.xr.addEventListener(`sessiongranted`,()=>{e.xrSessionIsGranted=!0})}}};Al.xrSessionIsGranted=!1,Al.registerSessionGrantedListener();var jl=.4,Ml=.16,Nl=.06,Pl=[{name:`1x1 Brick`,grid:[1,1,1],color:16724787},{name:`1x2 Brick`,grid:[1,2,1],color:3407667},{name:`2x4 Brick`,grid:[2,4,1],color:3355647},{name:`1x1 Plate`,grid:[1,1,1],color:16755200,isPlate:!0},{name:`1x2 Tile`,grid:[1,2,1],color:11184810,isTile:!0}];function Fl(e){let t=Pl.find(t=>t.name===e);if(!t)return null;let[n,r,i]=t.grid,a=t.isPlate||t.isTile?jl/3:jl*n,o=new Cn;o.name=e,o.userData.height=a;let s=new Jr(new wi(r*1,a,i*1),new Li({color:t.color}));if(o.add(s),!t.isTile){let e=new Ti(Ml,Ml,Nl,8),n=new Li({color:t.color});for(let t=0;t<r;t++)for(let s=0;s<i;s++){let c=new Jr(e,n);c.position.set((t-(r-1)/2)*1,a/2+Nl/2,(s-(i-1)/2)*1),o.add(c)}}return o}function Il(e,t){let n=document.getElementById(`piece-list`),r=null;return Pl.forEach(e=>{let i=document.createElement(`button`);i.textContent=e.name,i.addEventListener(`click`,()=>{n.querySelectorAll(`button`).forEach(e=>e.classList.remove(`active`)),i.classList.add(`active`),r=e.name,t&&t(e.name)}),n.appendChild(i)}),{getCurrentType:()=>r}}var Ll=new ti,Rl=new K,zl=new q,Bl=new K,Vl=new K,Hl=new q,Ul=new q,Wl=new Jt,Gl=new q,Kl=new q,ql=null,Jl=null,Yl=[],Xl={NONE:-1,PAN:0,ROTATE:1},Zl=class extends Va{constructor(n,r,i=null){super(r,i),this.objects=n,this.recursive=!0,this.transformGroup=!1,this.rotateSpeed=1,this.raycaster=new Ia,this.mouseButtons={LEFT:e.PAN,MIDDLE:e.PAN,RIGHT:e.ROTATE},this.touches={ONE:t.PAN},this._onPointerMove=Ql.bind(this),this._onPointerDown=$l.bind(this),this._onPointerCancel=eu.bind(this),this._onContextMenu=tu.bind(this),i!==null&&this.connect(i)}connect(e){super.connect(e),this.domElement.addEventListener(`pointermove`,this._onPointerMove),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointerup`,this._onPointerCancel),this.domElement.addEventListener(`pointerleave`,this._onPointerCancel),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.removeEventListener(`pointerup`,this._onPointerCancel),this.domElement.removeEventListener(`pointerleave`,this._onPointerCancel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.domElement.style.touchAction=``,this.domElement.style.cursor=``}dispose(){this.disconnect()}_updatePointer(e){let t=this.domElement.getBoundingClientRect();Rl.x=(e.clientX-t.left)/t.width*2-1,Rl.y=-(e.clientY-t.top)/t.height*2+1}_updateState(n){let r;if(n.pointerType===`touch`)r=this.touches.ONE;else switch(n.button){case 0:r=this.mouseButtons.LEFT;break;case 1:r=this.mouseButtons.MIDDLE;break;case 2:r=this.mouseButtons.RIGHT;break;default:r=null}switch(r){case e.PAN:case t.PAN:this.state=Xl.PAN;break;case e.ROTATE:case t.ROTATE:this.state=Xl.ROTATE;break;default:this.state=Xl.NONE}}};function Ql(e){let t=this.object,n=this.domElement,r=this.raycaster;if(this.enabled!==!1){if(this._updatePointer(e),r.setFromCamera(Rl,t),ql)this.state===Xl.PAN?r.ray.intersectPlane(Ll,Hl)&&(ql.position.copy(Hl.sub(zl).applyMatrix4(Wl)),this.dispatchEvent({type:`drag`,object:ql})):this.state===Xl.ROTATE&&(Bl.subVectors(Rl,Vl).multiplyScalar(this.rotateSpeed),ql.rotateOnWorldAxis(Gl,Bl.x),ql.rotateOnWorldAxis(Kl.normalize(),-Bl.y),this.dispatchEvent({type:`drag`,object:ql})),Vl.copy(Rl);else if(e.pointerType===`mouse`||e.pointerType===`pen`)if(Yl.length=0,r.setFromCamera(Rl,t),r.intersectObjects(this.objects,this.recursive,Yl),Yl.length>0){let e=Yl[0].object;Ll.setFromNormalAndCoplanarPoint(t.getWorldDirection(Ll.normal),Ul.setFromMatrixPosition(e.matrixWorld)),Jl!==e&&Jl!==null&&(this.dispatchEvent({type:`hoveroff`,object:Jl}),n.style.cursor=`auto`,Jl=null),Jl!==e&&(this.dispatchEvent({type:`hoveron`,object:e}),n.style.cursor=`pointer`,Jl=e)}else Jl!==null&&(this.dispatchEvent({type:`hoveroff`,object:Jl}),n.style.cursor=`auto`,Jl=null);Vl.copy(Rl)}}function $l(e){let t=this.object,n=this.domElement,r=this.raycaster;this.enabled!==!1&&(this._updatePointer(e),this._updateState(e),Yl.length=0,r.setFromCamera(Rl,t),r.intersectObjects(this.objects,this.recursive,Yl),Yl.length>0&&(ql=this.transformGroup===!0?nu(Yl[0].object):Yl[0].object,Ll.setFromNormalAndCoplanarPoint(t.getWorldDirection(Ll.normal),Ul.setFromMatrixPosition(ql.matrixWorld)),r.ray.intersectPlane(Ll,Hl)&&(this.state===Xl.PAN?(Wl.copy(ql.parent.matrixWorld).invert(),zl.copy(Hl).sub(Ul.setFromMatrixPosition(ql.matrixWorld)),n.style.cursor=`move`,this.dispatchEvent({type:`dragstart`,object:ql})):this.state===Xl.ROTATE&&(Gl.set(0,1,0).applyQuaternion(t.quaternion).normalize(),Kl.set(1,0,0).applyQuaternion(t.quaternion).normalize(),n.style.cursor=`move`,this.dispatchEvent({type:`dragstart`,object:ql})))),Vl.copy(Rl))}function eu(){this.enabled!==!1&&(ql&&=(this.dispatchEvent({type:`dragend`,object:ql}),null),this.domElement.style.cursor=Jl?`pointer`:`auto`,this.state=Xl.NONE)}function tu(e){this.enabled!==!1&&e.preventDefault()}function nu(e,t=null){return e.isGroup&&(t=e),e.parent===null?t:nu(e.parent,t)}function ru(e,t,n,r){let i=[],a=new Zl(i,e,t.domElement);a.transformGroup=!0,a.addEventListener(`dragstart`,()=>{r.enabled=!1}),a.addEventListener(`drag`,e=>{let t=e.object.userData.height||.4;e.object.position.x=Math.max(-10,Math.min(10,Math.round(e.object.position.x/1)*1)),e.object.position.z=Math.max(-10,Math.min(10,Math.round(e.object.position.z/1)*1));let n=Math.round((e.object.position.y-t/2)/jl);e.object.position.y=Math.max(t/2,n*jl+t/2)}),a.addEventListener(`dragend`,e=>{r.enabled=!0;let t=e.object.userData.height||.4;e.object.position.x=Math.round(e.object.position.x/1)*1,e.object.position.z=Math.round(e.object.position.z/1)*1;let n=Math.round((e.object.position.y-t/2)/jl);e.object.position.y=Math.max(t/2,n*jl+t/2)});function o(e){i.push(e)}function s(e){let t=i.indexOf(e);t>-1&&i.splice(t,1)}return{dragControls:a,addDraggable:o,removeDraggable:s,getDraggables:()=>i}}function iu(e,t,n,r){let i=new Ia,a=new K,o=!1,s=document.getElementById(`erase-mode`);return s.addEventListener(`click`,()=>{o=!o,s.classList.toggle(`active`,o)}),window.addEventListener(`click`,s=>{if(!o)return;a.x=s.clientX/window.innerWidth*2-1,a.y=-(s.clientY/window.innerHeight)*2+1,i.setFromCamera(a,e);let c=i.intersectObjects(n(),!0);if(c.length>0){let e=c[0].object;for(;e.parent&&e.parent!==t;)e=e.parent;t.remove(e),r(e)}}),{isEraserMode:()=>o}}function au(e){if(e===void 0)throw ReferenceError(`this hasn't been initialised - super() hasn't been called`);return e}function ou(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,e.__proto__=t}var su={autoSleep:120,force3D:`auto`,nullTargetWarn:1,units:{lineHeight:``}},cu={duration:.5,overwrite:!1,delay:0},lu,uu,du,fu=1e8,pu=1/fu,mu=Math.PI*2,hu=mu/4,gu=0,_u=Math.sqrt,vu=Math.cos,yu=Math.sin,bu=function(e){return typeof e==`string`},xu=function(e){return typeof e==`function`},Su=function(e){return typeof e==`number`},Cu=function(e){return e===void 0},wu=function(e){return typeof e==`object`},Tu=function(e){return e!==!1},Eu=function(){return typeof window<`u`},Du=function(e){return xu(e)||bu(e)},Ou=typeof ArrayBuffer==`function`&&ArrayBuffer.isView||function(){},ku=Array.isArray,Au=/random\([^)]+\)/g,ju=/,\s*/g,Mu=/(?:-?\.?\d|\.)+/gi,Nu=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Pu=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Fu=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Iu=/[+-]=-?[.\d]+/,Lu=/[^,'"\[\]\s]+/gi,Ru=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,zu,Bu,Vu,Hu,Uu={},Wu={},Gu,Ku=function(e){return(Wu=wd(e,Uu))&&Up},qu=function(e,t){return console.warn(`Invalid property`,e,`set to`,t,`Missing plugin? gsap.registerPlugin()`)},Ju=function(e,t){return!t&&console.warn(e)},Yu=function(e,t){return e&&(Uu[e]=t)&&Wu&&(Wu[e]=t)||Uu},Xu=function(){return 0},Zu={suppressEvents:!0,isStart:!0,kill:!1},Qu={suppressEvents:!0,kill:!1},$u={suppressEvents:!0},ed={},td=[],nd={},rd,id={},ad={},od=30,sd=[],cd=``,ld=function(e){var t=e[0],n,r;if(wu(t)||xu(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(r=sd.length;r--&&!sd[r].targetTest(t););n=sd[r]}for(r=e.length;r--;)e[r]&&(e[r]._gsap||(e[r]._gsap=new $f(e[r],n)))||e.splice(r,1);return e},ud=function(e){return e._gsap||ld(cf(e))[0]._gsap},dd=function(e,t,n){return(n=e[t])&&xu(n)?e[t]():Cu(n)&&e.getAttribute&&e.getAttribute(t)||n},fd=function(e,t){return(e=e.split(`,`)).forEach(t)||e},pd=function(e){return Math.round(e*1e5)/1e5||0},md=function(e){return Math.round(e*1e7)/1e7||0},hd=function(e,t){var n=t.charAt(0),r=parseFloat(t.substr(2));return e=parseFloat(e),n===`+`?e+r:n===`-`?e-r:n===`*`?e*r:e/r},gd=function(e,t){for(var n=t.length,r=0;e.indexOf(t[r])<0&&++r<n;);return r<n},_d=function(){var e=td.length,t=td.slice(0),n,r;for(nd={},td.length=0,n=0;n<e;n++)r=t[n],r&&r._lazy&&(r.render(r._lazy[0],r._lazy[1],!0)._lazy=0)},vd=function(e){return!!(e._initted||e._startAt||e.add)},yd=function(e,t,n,r){td.length&&!uu&&_d(),e.render(t,n,r||!!(uu&&t<0&&vd(e))),td.length&&!uu&&_d()},bd=function(e){var t=parseFloat(e);return(t||t===0)&&(e+``).match(Lu).length<2?t:bu(e)?e.trim():e},xd=function(e){return e},Sd=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},Cd=function(e){return function(t,n){for(var r in n)r in t||r===`duration`&&e||r===`ease`||(t[r]=n[r])}},wd=function(e,t){for(var n in t)e[n]=t[n];return e},Td=function e(t,n){for(var r in n)r!==`__proto__`&&r!==`constructor`&&r!==`prototype`&&(t[r]=wu(n[r])?e(t[r]||(t[r]={}),n[r]):n[r]);return t},Ed=function(e,t){var n={},r;for(r in e)r in t||(n[r]=e[r]);return n},Dd=function(e){var t=e.parent||zu,n=e.keyframes?Cd(ku(e.keyframes)):Sd;if(Tu(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},Od=function(e,t){for(var n=e.length,r=n===t.length;r&&n--&&e[n]===t[n];);return n<0},kd=function(e,t,n,r,i){n===void 0&&(n=`_first`),r===void 0&&(r=`_last`);var a=e[r],o;if(i)for(o=t[i];a&&a[i]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[r]=t,t._prev=a,t.parent=t._dp=e,t},Ad=function(e,t,n,r){n===void 0&&(n=`_first`),r===void 0&&(r=`_last`);var i=t._prev,a=t._next;i?i._next=a:e[n]===t&&(e[n]=a),a?a._prev=i:e[r]===t&&(e[r]=i),t._next=t._prev=t.parent=null},jd=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Md=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},Nd=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},Pd=function(e,t,n,r){return e._startAt&&(uu?e._startAt.revert(Qu):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,r))},Fd=function e(t){return!t||t._ts&&e(t.parent)},Id=function(e){return e._repeat?Ld(e._tTime,e=e.duration()+e._rDelay)*e:0},Ld=function(e,t){var n=Math.floor(e=md(e/t));return e&&n===e?n-1:n},Rd=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},zd=function(e){return e._end=md(e._start+(e._tDur/Math.abs(e._ts||e._rts||pu)||0))},Bd=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=md(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),zd(e),n._dirty||Md(n,e)),e},Vd=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Rd(e.rawTime(),t),(!t._dur||tf(0,t.totalDuration(),n)-t._tTime>pu)&&t.render(n,!0)),Md(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-pu}},Hd=function(e,t,n,r){return t.parent&&jd(t),t._start=md((Su(n)?n:n||e!==zu?Qd(e,n,t):e._time)+t._delay),t._end=md(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),kd(e,t,`_first`,`_last`,e._sort?`_start`:0),Kd(t)||(e._recent=t),r||Vd(e,t),e._ts<0&&Bd(e,e._tTime),e},Ud=function(e,t){return(Uu.ScrollTrigger||qu(`scrollTrigger`,t))&&Uu.ScrollTrigger.create(t,e)},Wd=function(e,t,n,r,i){if(cp(e,t,i),!e._initted)return 1;if(!n&&e._pt&&!uu&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&rd!==Bf.frame)return td.push(e),e._lazy=[i,r],1},Gd=function e(t){var n=t.parent;return n&&n._ts&&n._initted&&!n._lock&&(n.rawTime()<0||e(n))},Kd=function(e){var t=e.data;return t===`isFromStart`||t===`isStart`},qd=function(e,t,n,r){var i=e.ratio,a=t<0||!t&&(!e._start&&Gd(e)&&!(!e._initted&&Kd(e))||(e._ts<0||e._dp._ts<0)&&!Kd(e))?0:1,o=e._rDelay,s=0,c,l,u;if(o&&e._repeat&&(s=tf(0,e._tDur,t),l=Ld(s,o),e._yoyo&&l&1&&(a=1-a),l!==Ld(e._tTime,o)&&(i=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==i||uu||r||e._zTime===pu||!t&&e._zTime){if(!e._initted&&Wd(e,t,r,n,s))return;for(u=e._zTime,e._zTime=t||(n?pu:0),n||=t&&!u,e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=s,c=e._pt;c;)c.r(a,c.d),c=c._next;t<0&&Pd(e,t,n,!0),e._onUpdate&&!n&&Tf(e,`onUpdate`),s&&e._repeat&&!n&&e.parent&&Tf(e,`onRepeat`),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&jd(e,1),!n&&!uu&&(Tf(e,a?`onComplete`:`onReverseComplete`,!0),e._prom&&e._prom()))}else e._zTime||=t},Jd=function(e,t,n){var r;if(n>t)for(r=e._first;r&&r._start<=n;){if(r.data===`isPause`&&r._start>t)return r;r=r._next}else for(r=e._last;r&&r._start>=n;){if(r.data===`isPause`&&r._start<t)return r;r=r._prev}},Yd=function(e,t,n,r){var i=e._repeat,a=md(t)||0,o=e._tTime/e._tDur;return o&&!r&&(e._time*=a/e._dur),e._dur=a,e._tDur=i?i<0?1e10:md(a*(i+1)+e._rDelay*i):a,o>0&&!r&&Bd(e,e._tTime=e._tDur*o),e.parent&&zd(e),n||Md(e.parent,e),e},Xd=function(e){return e instanceof tp?Md(e):Yd(e,e._dur)},Zd={_start:0,endTime:Xu,totalDuration:Xu},Qd=function e(t,n,r){var i=t.labels,a=t._recent||Zd,o=t.duration()>=fu?a.endTime(!1):t._dur,s,c,l;return bu(n)&&(isNaN(n)||n in i)?(c=n.charAt(0),l=n.substr(-1)===`%`,s=n.indexOf(`=`),c===`<`||c===`>`?(s>=0&&(n=n.replace(/=/,``)),(c===`<`?a._start:a.endTime(a._repeat>=0))+(parseFloat(n.substr(1))||0)*(l?(s<0?a:r).totalDuration()/100:1)):s<0?(n in i||(i[n]=o),i[n]):(c=parseFloat(n.charAt(s-1)+n.substr(s+1)),l&&r&&(c=c/100*(ku(r)?r[0]:r).totalDuration()),s>1?e(t,n.substr(0,s-1),r)+c:o+c)):n==null?o:+n},$d=function(e,t,n){var r=Su(t[1]),i=(r?2:1)+(e<2?0:1),a=t[i],o,s;if(r&&(a.duration=t[1]),a.parent=n,e){for(o=a,s=n;s&&!(`immediateRender`in o);)o=s.vars.defaults||{},s=Tu(s.vars.inherit)&&s.parent;a.immediateRender=Tu(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[i-1]}return new hp(t[0],a,t[i+1])},ef=function(e,t){return e||e===0?t(e):t},tf=function(e,t,n){return n<e?e:n>t?t:n},nf=function(e,t){return!bu(e)||!(t=Ru.exec(e))?``:t[1]},rf=function(e,t,n){return ef(n,function(n){return tf(e,t,n)})},af=[].slice,of=function(e,t){return e&&wu(e)&&`length`in e&&(!t&&!e.length||e.length-1 in e&&wu(e[0]))&&!e.nodeType&&e!==Bu},sf=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(e){var r;return bu(e)&&!t||of(e,1)?(r=n).push.apply(r,cf(e)):n.push(e)})||n},cf=function(e,t,n){return du&&!t&&du.selector?du.selector(e):bu(e)&&!n&&(Vu||!Vf())?af.call((t||Hu).querySelectorAll(e),0):ku(e)?sf(e,n):of(e)?af.call(e,0):e?[e]:[]},lf=function(e){return e=cf(e)[0]||Ju(`Invalid scope`)||{},function(t){var n=e.current||e.nativeElement||e;return cf(t,n.querySelectorAll?n:n===e?Ju(`Invalid scope`)||Hu.createElement(`div`):e)}},uf=function(e){return e.sort(function(){return .5-Math.random()})},df=function(e){if(xu(e))return e;var t=wu(e)?e:{each:e},n=Jf(t.ease),r=t.from||0,i=parseFloat(t.base)||0,a={},o=r>0&&r<1,s=isNaN(r)||o,c=t.axis,l=r,u=r;return bu(r)?l=u={center:.5,edges:.5,end:1}[r]||0:!o&&s&&(l=r[0],u=r[1]),function(e,o,d){var f=(d||t).length,p=a[f],m,h,g,_,v,y,b,x,S;if(!p){if(S=t.grid===`auto`?0:(t.grid||[1,fu])[1],!S){for(b=-fu;b<(b=d[S++].getBoundingClientRect().left)&&S<f;);S<f&&S--}for(p=a[f]=[],m=s?Math.min(S,f)*l-.5:r%S,h=S===fu?0:s?f*u/S-.5:r/S|0,b=0,x=fu,y=0;y<f;y++)g=y%S-m,_=h-(y/S|0),p[y]=v=c?Math.abs(c===`y`?_:g):_u(g*g+_*_),v>b&&(b=v),v<x&&(x=v);r===`random`&&uf(p),p.max=b-x,p.min=x,p.v=f=(parseFloat(t.amount)||parseFloat(t.each)*(S>f?f-1:c?c===`y`?f/S:S:Math.max(S,f/S))||0)*(r===`edges`?-1:1),p.b=f<0?i-f:i,p.u=nf(t.amount||t.each)||0,n=n&&f<0?qf(n):n}return f=(p[e]-p.min)/p.max||0,md(p.b+(n?n(f):f)*p.v)+p.u}},ff=function(e){var t=10**((e+``).split(`.`)[1]||``).length;return function(n){var r=md(Math.round(parseFloat(n)/e)*e*t);return(r-r%1)/t+(Su(n)?0:nf(n))}},pf=function(e,t){var n=ku(e),r,i;return!n&&wu(e)&&(r=n=e.radius||fu,e.values?(e=cf(e.values),(i=!Su(e[0]))&&(r*=r)):e=ff(e.increment)),ef(t,n?xu(e)?function(t){return i=e(t),Math.abs(i-t)<=r?i:t}:function(t){for(var n=parseFloat(i?t.x:t),a=parseFloat(i?t.y:0),o=fu,s=0,c=e.length,l,u;c--;)i?(l=e[c].x-n,u=e[c].y-a,l=l*l+u*u):l=Math.abs(e[c]-n),l<o&&(o=l,s=c);return s=!r||o<=r?e[s]:t,i||s===t||Su(t)?s:s+nf(t)}:ff(e))},mf=function(e,t,n,r){return ef(ku(e)?!t:n===!0?!!(n=0):!r,function(){return ku(e)?e[~~(Math.random()*e.length)]:(n||=1e-5)&&(r=n<1?10**((n+``).length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*r)/r})},hf=function(){var e=[...arguments];return function(t){return e.reduce(function(e,t){return t(e)},t)}},gf=function(e,t){return function(n){return e(parseFloat(n))+(t||nf(n))}},_f=function(e,t,n){return Sf(e,t,0,1,n)},vf=function(e,t,n){return ef(n,function(n){return e[~~t(n)]})},yf=function e(t,n,r){var i=n-t;return ku(t)?vf(t,e(0,t.length),n):ef(r,function(e){return(i+(e-t)%i)%i+t})},bf=function e(t,n,r){var i=n-t,a=i*2;return ku(t)?vf(t,e(0,t.length-1),n):ef(r,function(e){return e=(a+(e-t)%a)%a||0,t+(e>i?a-e:e)})},xf=function(e){return e.replace(Au,function(e){var t=e.indexOf(`[`)+1,n=e.substring(t||7,t?e.indexOf(`]`):e.length-1).split(ju);return mf(t?n:+n[0],t?0:+n[1],+n[2]||1e-5)})},Sf=function(e,t,n,r,i){var a=t-e,o=r-n;return ef(i,function(t){return n+((t-e)/a*o||0)})},Cf=function e(t,n,r,i){var a=isNaN(t+n)?0:function(e){return(1-e)*t+e*n};if(!a){var o=bu(t),s={},c,l,u,d,f;if(r===!0&&(i=1)&&(r=null),o)t={p:t},n={p:n};else if(ku(t)&&!ku(n)){for(u=[],d=t.length,f=d-2,l=1;l<d;l++)u.push(e(t[l-1],t[l]));d--,a=function(e){e*=d;var t=Math.min(f,~~e);return u[t](e-t)},r=n}else i||(t=wd(ku(t)?[]:{},t));if(!u){for(c in n)rp.call(s,t,c,`get`,n[c]);a=function(e){return wp(e,s)||(o?t.p:t)}}}return ef(r,a)},wf=function(e,t,n){var r=e.labels,i=fu,a,o,s;for(a in r)o=r[a]-t,o<0==!!n&&o&&i>(o=Math.abs(o))&&(s=a,i=o);return s},Tf=function(e,t,n){var r=e.vars,i=r[t],a=du,o=e._ctx,s,c,l;if(i)return s=r[t+`Params`],c=r.callbackScope||e,n&&td.length&&_d(),o&&(du=o),l=s?i.apply(c,s):i.call(c),du=a,l},Ef=function(e){return jd(e),e.scrollTrigger&&e.scrollTrigger.kill(!!uu),e.progress()<1&&Tf(e,`onInterrupt`),e},Df,Of=[],kf=function(e){if(e)if(e=!e.name&&e.default||e,Eu()||e.headless){var t=e.name,n=xu(e),r=t&&!n&&e.init?function(){this._props=[]}:e,i={init:Xu,render:wp,add:rp,kill:Ep,modifier:Tp,rawVars:0},a={targetTest:0,get:0,getSetter:bp,aliases:{},register:0};if(Vf(),e!==r){if(id[t])return;Sd(r,Sd(Ed(e,i),a)),wd(r.prototype,wd(i,Ed(e,a))),id[r.prop=t]=r,e.targetTest&&(sd.push(r),ed[t]=1),t=(t===`css`?`CSS`:t.charAt(0).toUpperCase()+t.substr(1))+`Plugin`}Yu(t,r),e.register&&e.register(Up,r,kp)}else Of.push(e)},Af=255,jf={aqua:[0,Af,Af],lime:[0,Af,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Af],navy:[0,0,128],white:[Af,Af,Af],olive:[128,128,0],yellow:[Af,Af,0],orange:[Af,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Af,0,0],pink:[Af,192,203],cyan:[0,Af,Af],transparent:[Af,Af,Af,0]},Mf=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*Af+.5|0},Nf=function(e,t,n){var r=e?Su(e)?[e>>16,e>>8&Af,e&Af]:0:jf.black,i,a,o,s,c,l,u,d,f,p;if(!r){if(e.substr(-1)===`,`&&(e=e.substr(0,e.length-1)),jf[e])r=jf[e];else if(e.charAt(0)===`#`){if(e.length<6&&(i=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e=`#`+i+i+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):``)),e.length===9)return r=parseInt(e.substr(1,6),16),[r>>16,r>>8&Af,r&Af,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),r=[e>>16,e>>8&Af,e&Af]}else if(e.substr(0,3)===`hsl`){if(r=p=e.match(Mu),!t)s=r[0]%360/360,c=r[1]/100,l=r[2]/100,a=l<=.5?l*(c+1):l+c-l*c,i=l*2-a,r.length>3&&(r[3]*=1),r[0]=Mf(s+1/3,i,a),r[1]=Mf(s,i,a),r[2]=Mf(s-1/3,i,a);else if(~e.indexOf(`=`))return r=e.match(Nu),n&&r.length<4&&(r[3]=1),r}else r=e.match(Mu)||jf.transparent;r=r.map(Number)}return t&&!p&&(i=r[0]/Af,a=r[1]/Af,o=r[2]/Af,u=Math.max(i,a,o),d=Math.min(i,a,o),l=(u+d)/2,u===d?s=c=0:(f=u-d,c=l>.5?f/(2-u-d):f/(u+d),s=u===i?(a-o)/f+(a<o?6:0):u===a?(o-i)/f+2:(i-a)/f+4,s*=60),r[0]=~~(s+.5),r[1]=~~(c*100+.5),r[2]=~~(l*100+.5)),n&&r.length<4&&(r[3]=1),r},Pf=function(e){var t=[],n=[],r=-1;return e.split(If).forEach(function(e){var i=e.match(Pu)||[];t.push.apply(t,i),n.push(r+=i.length+1)}),t.c=n,t},Ff=function(e,t,n){var r=``,i=(e+r).match(If),a=t?`hsla(`:`rgba(`,o=0,s,c,l,u;if(!i)return e;if(i=i.map(function(e){return(e=Nf(e,t,1))&&a+(t?e[0]+`,`+e[1]+`%,`+e[2]+`%,`+e[3]:e.join(`,`))+`)`}),n&&(l=Pf(e),s=n.c,s.join(r)!==l.c.join(r)))for(c=e.replace(If,`1`).split(Pu),u=c.length-1;o<u;o++)r+=c[o]+(~s.indexOf(o)?i.shift()||a+`0,0,0,0)`:(l.length?l:i.length?i:n).shift());if(!c)for(c=e.split(If),u=c.length-1;o<u;o++)r+=c[o]+i[o];return r+c[u]},If=function(){var e=`(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b`,t;for(t in jf)e+=`|`+t+`\\b`;return RegExp(e+`)`,`gi`)}(),Lf=/hsl[a]?\(/,Rf=function(e){var t=e.join(` `),n;if(If.lastIndex=0,If.test(t))return n=Lf.test(t),e[1]=Ff(e[1],n),e[0]=Ff(e[0],n,Pf(e[1])),!0},zf,Bf=function(){var e=Date.now,t=500,n=33,r=e(),i=r,a=1e3/240,o=a,s=[],c,l,u,d,f,p,m=function u(m){var h=e()-i,g=m===!0,_,v,y,b;if((h>t||h<0)&&(r+=h-n),i+=h,y=i-r,_=y-o,(_>0||g)&&(b=++d.frame,f=y-d.time*1e3,d.time=y/=1e3,o+=_+(_>=a?4:a-_),v=1),g||(c=l(u)),v)for(p=0;p<s.length;p++)s[p](y,f,b,m)};return d={time:0,frame:0,tick:function(){m(!0)},deltaRatio:function(e){return f/(1e3/(e||60))},wake:function(){Gu&&(!Vu&&Eu()&&(Bu=Vu=window,Hu=Bu.document||{},Uu.gsap=Up,(Bu.gsapVersions||=[]).push(Up.version),Ku(Wu||Bu.GreenSockGlobals||!Bu.gsap&&Bu||{}),Of.forEach(kf)),u=typeof requestAnimationFrame<`u`&&requestAnimationFrame,c&&d.sleep(),l=u||function(e){return setTimeout(e,o-d.time*1e3+1|0)},zf=1,m(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(c),zf=0,l=Xu},lagSmoothing:function(e,r){t=e||1/0,n=Math.min(r||33,t)},fps:function(e){a=1e3/(e||240),o=d.time*1e3+a},add:function(e,t,n){var r=t?function(t,n,i,a){e(t,n,i,a),d.remove(r)}:e;return d.remove(e),s[n?`unshift`:`push`](r),Vf(),r},remove:function(e,t){~(t=s.indexOf(e))&&s.splice(t,1)&&p>=t&&p--},_listeners:s},d}(),Vf=function(){return!zf&&Bf.wake()},$={},Hf=/^[\d.\-M][\d.\-,\s]/,Uf=/["']/g,Wf=function(e){for(var t={},n=e.substr(1,e.length-3).split(`:`),r=n[0],i=1,a=n.length,o,s,c;i<a;i++)s=n[i],o=i===a-1?s.length:s.lastIndexOf(`,`),c=s.substr(0,o),t[r]=isNaN(c)?c.replace(Uf,``).trim():+c,r=s.substr(o+1).trim();return t},Gf=function(e){var t=e.indexOf(`(`)+1,n=e.indexOf(`)`),r=e.indexOf(`(`,t);return e.substring(t,~r&&r<n?e.indexOf(`)`,n+1):n)},Kf=function(e){var t=(e+``).split(`(`),n=$[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf(`{`)?[Wf(t[1])]:Gf(e).split(`,`).map(bd)):$._CE&&Hf.test(e)?$._CE(``,e):n},qf=function(e){return function(t){return 1-e(1-t)}},Jf=function(e,t){return e&&(xu(e)?e:$[e]||Kf(e))||t},Yf=function(e,t,n,r){n===void 0&&(n=function(e){return 1-t(1-e)}),r===void 0&&(r=function(e){return e<.5?t(e*2)/2:1-t((1-e)*2)/2});var i={easeIn:t,easeOut:n,easeInOut:r},a;return fd(e,function(e){for(var t in $[e]=Uu[e]=i,$[a=e.toLowerCase()]=n,i)$[a+(t===`easeIn`?`.in`:t===`easeOut`?`.out`:`.inOut`)]=$[e+`.`+t]=i[t]}),i},Xf=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},Zf=function e(t,n,r){var i=n>=1?n:1,a=(r||(t?.3:.45))/(n<1?n:1),o=a/mu*(Math.asin(1/i)||0),s=function(e){return e===1?1:i*2**(-10*e)*yu((e-o)*a)+1},c=t===`out`?s:t===`in`?function(e){return 1-s(1-e)}:Xf(s);return a=mu/a,c.config=function(n,r){return e(t,n,r)},c},Qf=function e(t,n){n===void 0&&(n=1.70158);var r=function(e){return e?--e*e*((n+1)*e+n)+1:0},i=t===`out`?r:t===`in`?function(e){return 1-r(1-e)}:Xf(r);return i.config=function(n){return e(t,n)},i};fd(`Linear,Quad,Cubic,Quart,Quint,Strong`,function(e,t){var n=t<5?t+1:t;Yf(e+`,Power`+(n-1),t?function(e){return e**+n}:function(e){return e},function(e){return 1-(1-e)**n},function(e){return e<.5?(e*2)**n/2:1-((1-e)*2)**n/2})}),$.Linear.easeNone=$.none=$.Linear.easeIn,Yf(`Elastic`,Zf(`in`),Zf(`out`),Zf()),(function(e,t){var n=1/t,r=2*n,i=2.5*n,a=function(a){return a<n?e*a*a:a<r?e*(a-1.5/t)**2+.75:a<i?e*(a-=2.25/t)*a+.9375:e*(a-2.625/t)**2+.984375};Yf(`Bounce`,function(e){return 1-a(1-e)},a)})(7.5625,2.75),Yf(`Expo`,function(e){return 2**(10*(e-1))*e+e*e*e*e*e*e*(1-e)}),Yf(`Circ`,function(e){return-(_u(1-e*e)-1)}),Yf(`Sine`,function(e){return e===1?1:-vu(e*hu)+1}),Yf(`Back`,Qf(`in`),Qf(`out`),Qf()),$.SteppedEase=$.steps=Uu.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,r=e+ +!t,i=+!!t,a=1-pu;return function(e){return((r*tf(0,a,e)|0)+i)*n}}},cu.ease=$[`quad.out`],fd(`onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt`,function(e){return cd+=e+`,`+e+`Params,`});var $f=function(e,t){this.id=gu++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:dd,this.set=t?t.getSetter:bp},ep=function(){function e(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,Yd(this,+e.duration,1,1),this.data=e.data,du&&(this._ctx=du,du.data.push(this)),zf||Bf.wake()}var t=e.prototype;return t.delay=function(e){return e||e===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+e-this._delay),this._delay=e,this):this._delay},t.duration=function(e){return arguments.length?this.totalDuration(this._repeat>0?e+(e+this._rDelay)*this._repeat:e):this.totalDuration()&&this._dur},t.totalDuration=function(e){return arguments.length?(this._dirty=0,Yd(this,this._repeat<0?e:(e-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(e,t){if(Vf(),!arguments.length)return this._tTime;var n=this._dp;if(n&&n.smoothChildTiming&&this._ts){for(Bd(this,e),!n._dp||n.parent||Vd(n,this);n&&n.parent;)n.parent._time!==n._start+(n._ts>=0?n._tTime/n._ts:(n.totalDuration()-n._tTime)/-n._ts)&&n.totalTime(n._tTime,!0),n=n.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&e<this._tDur||this._ts<0&&e>0||!this._tDur&&!e)&&Hd(this._dp,this,this._start-this._delay)}return(this._tTime!==e||!this._dur&&!t||this._initted&&Math.abs(this._zTime)===pu||!this._initted&&this._dur&&e||!e&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=e),yd(this,e,t)),this},t.time=function(e,t){return arguments.length?this.totalTime(Math.min(this.totalDuration(),e+Id(this))%(this._dur+this._rDelay)||(e?this._dur:0),t):this._time},t.totalProgress=function(e,t){return arguments.length?this.totalTime(this.totalDuration()*e,t):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(e,t){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-e:e)+Id(this),t):this.duration()?Math.min(1,this._time/this._dur):+(this.rawTime()>0)},t.iteration=function(e,t){var n=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(e-1)*n,t):this._repeat?Ld(this._tTime,n)+1:1},t.timeScale=function(e,t){if(!arguments.length)return this._rts===-pu?0:this._rts;if(this._rts===e)return this;var n=this.parent&&this._ts?Rd(this.parent._time,this):this._tTime;return this._rts=+e||0,this._ts=this._ps||e===-pu?0:this._rts,this.totalTime(tf(-Math.abs(this._delay),this.totalDuration(),n),t!==!1),zd(this),Nd(this)},t.paused=function(e){return arguments.length?(this._ps!==e&&(this._ps=e,e?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Vf(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==pu&&(this._tTime-=pu)))),this):this._ps},t.startTime=function(e){if(arguments.length){this._start=md(e);var t=this.parent||this._dp;return t&&(t._sort||!this.parent)&&Hd(t,this,this._start-this._delay),this}return this._start},t.endTime=function(e){return this._start+(Tu(e)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(e){var t=this.parent||this._dp;return t?e&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Rd(t.rawTime(e),this):this._tTime:this._tTime},t.revert=function(e){e===void 0&&(e=$u);var t=uu;return uu=e,vd(this)&&(this.timeline&&this.timeline.revert(e),this.totalTime(-.01,e.suppressEvents)),this.data!==`nested`&&e.kill!==!1&&this.kill(),uu=t,this},t.globalTime=function(e){for(var t=this,n=arguments.length?e:t.rawTime();t;)n=t._start+n/(Math.abs(t._ts)||1),t=t._dp;return!this.parent&&this._sat?this._sat.globalTime(e):n},t.repeat=function(e){return arguments.length?(this._repeat=e===1/0?-2:e,Xd(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(e){if(arguments.length){var t=this._time;return this._rDelay=e,Xd(this),t?this.time(t):this}return this._rDelay},t.yoyo=function(e){return arguments.length?(this._yoyo=e,this):this._yoyo},t.seek=function(e,t){return this.totalTime(Qd(this,e),Tu(t))},t.restart=function(e,t){return this.play().totalTime(e?-this._delay:0,Tu(t)),this._dur||(this._zTime=-pu),this},t.play=function(e,t){return e!=null&&this.seek(e,t),this.reversed(!1).paused(!1)},t.reverse=function(e,t){return e!=null&&this.seek(e||this.totalDuration(),t),this.reversed(!0).paused(!1)},t.pause=function(e,t){return e!=null&&this.seek(e,t),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(e){return arguments.length?(!!e!==this.reversed()&&this.timeScale(-this._rts||(e?-pu:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-pu,this},t.isActive=function(){var e=this.parent||this._dp,t=this._start,n;return!!(!e||this._ts&&this._initted&&e.isActive()&&(n=e.rawTime(!0))>=t&&n<this.endTime(!0)-pu)},t.eventCallback=function(e,t,n){var r=this.vars;return arguments.length>1?(t?(r[e]=t,n&&(r[e+`Params`]=n),e===`onUpdate`&&(this._onUpdate=t)):delete r[e],this):r[e]},t.then=function(e){var t=this,n=t._prom;return new Promise(function(r){var i=xu(e)?e:xd,a=function(){var e=t.then;t.then=null,n&&n(),xu(i)&&(i=i(t))&&(i.then||i===t)&&(t.then=e),r(i),t.then=e};t._initted&&t.totalProgress()===1&&t._ts>=0||!t._tTime&&t._ts<0?a():t._prom=a})},t.kill=function(){Ef(this)},e}();Sd(ep.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-pu,_prom:0,_ps:!1,_rts:1});var tp=function(e){ou(t,e);function t(t,n){var r;return t===void 0&&(t={}),r=e.call(this,t)||this,r.labels={},r.smoothChildTiming=!!t.smoothChildTiming,r.autoRemoveChildren=!!t.autoRemoveChildren,r._sort=Tu(t.sortChildren),zu&&Hd(t.parent||zu,au(r),n),t.reversed&&r.reverse(),t.paused&&r.paused(!0),t.scrollTrigger&&Ud(au(r),t.scrollTrigger),r}var n=t.prototype;return n.to=function(e,t,n){return $d(0,arguments,this),this},n.from=function(e,t,n){return $d(1,arguments,this),this},n.fromTo=function(e,t,n,r){return $d(2,arguments,this),this},n.set=function(e,t,n){return t.duration=0,t.parent=this,Dd(t).repeatDelay||(t.repeat=0),t.immediateRender=!!t.immediateRender,new hp(e,t,Qd(this,n),1),this},n.call=function(e,t,n){return Hd(this,hp.delayedCall(0,e,t),n)},n.staggerTo=function(e,t,n,r,i,a,o){return n.duration=t,n.stagger=n.stagger||r,n.onComplete=a,n.onCompleteParams=o,n.parent=this,new hp(e,n,Qd(this,i)),this},n.staggerFrom=function(e,t,n,r,i,a,o){return n.runBackwards=1,Dd(n).immediateRender=Tu(n.immediateRender),this.staggerTo(e,t,n,r,i,a,o)},n.staggerFromTo=function(e,t,n,r,i,a,o,s){return r.startAt=n,Dd(r).immediateRender=Tu(r.immediateRender),this.staggerTo(e,t,r,i,a,o,s)},n.render=function(e,t,n){var r=this._time,i=this._dirty?this.totalDuration():this._tDur,a=this._dur,o=e<=0?0:md(e),s=this._zTime<0!=e<0&&(this._initted||!a),c,l,u,d,f,p,m,h,g,_,v,y;if(this!==zu&&o>i&&e>=0&&(o=i),o!==this._tTime||n||s){if(r!==this._time&&a&&(o+=this._time-r,e+=this._time-r),c=o,g=this._start,h=this._ts,p=!h,s&&(a||(r=this._zTime),(e||!t)&&(this._zTime=e)),this._repeat){if(v=this._yoyo,f=a+this._rDelay,this._repeat<-1&&e<0)return this.totalTime(f*100+e,t,n);if(c=md(o%f),o===i?(d=this._repeat,c=a):(_=md(o/f),d=~~_,d&&d===_&&(c=a,d--),c>a&&(c=a)),_=Ld(this._tTime,f),!r&&this._tTime&&_!==d&&this._tTime-_*f-this._dur<=0&&(_=d),v&&d&1&&(c=a-c,y=1),d!==_&&!this._lock){var b=v&&_&1,x=b===(v&&d&1);if(d<_&&(b=!b),r=b?0:o%a?a:o,this._lock=1,this.render(r||(y?0:md(d*f)),t,!a)._lock=0,this._tTime=o,!t&&this.parent&&Tf(this,`onRepeat`),this.vars.repeatRefresh&&!y&&(this.invalidate()._lock=1,_=d),r&&r!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act||(a=this._dur,i=this._tDur,x&&(this._lock=2,r=b?a:-1e-4,this.render(r,!0),this.vars.repeatRefresh&&!y&&this.invalidate()),this._lock=0,!this._ts&&!p))return this}}if(this._hasPause&&!this._forcing&&this._lock<2&&(m=Jd(this,md(r),md(c)),m&&(o-=c-(c=m._start))),this._tTime=o,this._time=c,this._act=!!h,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=e,r=0),!r&&o&&a&&!t&&!_&&(Tf(this,`onStart`),this._tTime!==o))return this;if(c>=r&&e>=0)for(l=this._first;l;){if(u=l._next,(l._act||c>=l._start)&&l._ts&&m!==l){if(l.parent!==this)return this.render(e,t,n);if(l.render(l._ts>0?(c-l._start)*l._ts:(l._dirty?l.totalDuration():l._tDur)+(c-l._start)*l._ts,t,n),c!==this._time||!this._ts&&!p){m=0,u&&(o+=this._zTime=-pu);break}}l=u}else{l=this._last;for(var S=e<0?e:c;l;){if(u=l._prev,(l._act||S<=l._end)&&l._ts&&m!==l){if(l.parent!==this)return this.render(e,t,n);if(l.render(l._ts>0?(S-l._start)*l._ts:(l._dirty?l.totalDuration():l._tDur)+(S-l._start)*l._ts,t,n||uu&&vd(l)),c!==this._time||!this._ts&&!p){m=0,u&&(o+=this._zTime=S?-pu:pu);break}}l=u}}if(m&&!t&&(this.pause(),m.render(c>=r?0:-pu)._zTime=c>=r?1:-1,this._ts))return this._start=g,zd(this),this.render(e,t,n);this._onUpdate&&!t&&Tf(this,`onUpdate`,!0),(o===i&&this._tTime>=this.totalDuration()||!o&&r)&&(g===this._start||Math.abs(h)!==Math.abs(this._ts))&&(this._lock||((e||!a)&&(o===i&&this._ts>0||!o&&this._ts<0)&&jd(this,1),!t&&!(e<0&&!r)&&(o||r||!i)&&(Tf(this,o===i&&e>=0?`onComplete`:`onReverseComplete`,!0),this._prom&&!(o<i&&this.timeScale()>0)&&this._prom())))}return this},n.add=function(e,t){var n=this;if(Su(t)||(t=Qd(this,t,e)),!(e instanceof ep)){if(ku(e))return e.forEach(function(e){return n.add(e,t)}),this;if(bu(e))return this.addLabel(e,t);if(xu(e))e=hp.delayedCall(0,e);else return this}return this===e?this:Hd(this,e,t)},n.getChildren=function(e,t,n,r){e===void 0&&(e=!0),t===void 0&&(t=!0),n===void 0&&(n=!0),r===void 0&&(r=-fu);for(var i=[],a=this._first;a;)a._start>=r&&(a instanceof hp?t&&i.push(a):(n&&i.push(a),e&&i.push.apply(i,a.getChildren(!0,t,n)))),a=a._next;return i},n.getById=function(e){for(var t=this.getChildren(1,1,1),n=t.length;n--;)if(t[n].vars.id===e)return t[n]},n.remove=function(e){return bu(e)?this.removeLabel(e):xu(e)?this.killTweensOf(e):(e.parent===this&&Ad(this,e),e===this._recent&&(this._recent=this._last),Md(this))},n.totalTime=function(t,n){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=md(Bf.time-(this._ts>0?t/this._ts:(this.totalDuration()-t)/-this._ts))),e.prototype.totalTime.call(this,t,n),this._forcing=0,this):this._tTime},n.addLabel=function(e,t){return this.labels[e]=Qd(this,t),this},n.removeLabel=function(e){return delete this.labels[e],this},n.addPause=function(e,t,n){var r=hp.delayedCall(0,t||Xu,n);return r.data=`isPause`,this._hasPause=1,Hd(this,r,Qd(this,e))},n.removePause=function(e){var t=this._first;for(e=Qd(this,e);t;)t._start===e&&t.data===`isPause`&&jd(t),t=t._next},n.killTweensOf=function(e,t,n){for(var r=this.getTweensOf(e,n),i=r.length;i--;)op!==r[i]&&r[i].kill(e,t);return this},n.getTweensOf=function(e,t){for(var n=[],r=cf(e),i=this._first,a=Su(t),o;i;)i instanceof hp?gd(i._targets,r)&&(a?(!op||i._initted&&i._ts)&&i.globalTime(0)<=t&&i.globalTime(i.totalDuration())>t:!t||i.isActive())&&n.push(i):(o=i.getTweensOf(r,t)).length&&n.push.apply(n,o),i=i._next;return n},n.tweenTo=function(e,t){t||={};var n=this,r=Qd(n,e),i=t,a=i.startAt,o=i.onStart,s=i.onStartParams,c=i.immediateRender,l,u=hp.to(n,Sd({ease:t.ease||`none`,lazy:!1,immediateRender:!1,time:r,overwrite:`auto`,duration:t.duration||Math.abs((r-(a&&`time`in a?a.time:n._time))/n.timeScale())||pu,onStart:function(){if(n.pause(),!l){var e=t.duration||Math.abs((r-(a&&`time`in a?a.time:n._time))/n.timeScale());u._dur!==e&&Yd(u,e,0,1).render(u._time,!0,!0),l=1}o&&o.apply(u,s||[])}},t));return c?u.render(0):u},n.tweenFromTo=function(e,t,n){return this.tweenTo(t,Sd({startAt:{time:Qd(this,e)}},n))},n.recent=function(){return this._recent},n.nextLabel=function(e){return e===void 0&&(e=this._time),wf(this,Qd(this,e))},n.previousLabel=function(e){return e===void 0&&(e=this._time),wf(this,Qd(this,e),1)},n.currentLabel=function(e){return arguments.length?this.seek(e,!0):this.previousLabel(this._time+pu)},n.shiftChildren=function(e,t,n){n===void 0&&(n=0);var r=this._first,i=this.labels,a;for(e=md(e);r;)r._start>=n&&(r._start+=e,r._end+=e),r=r._next;if(t)for(a in i)i[a]>=n&&(i[a]+=e);return Md(this)},n.invalidate=function(t){var n=this._first;for(this._lock=0;n;)n.invalidate(t),n=n._next;return e.prototype.invalidate.call(this,t)},n.clear=function(e){e===void 0&&(e=!0);for(var t=this._first,n;t;)n=t._next,this.remove(t),t=n;return this._dp&&(this._time=this._tTime=this._pTime=0),e&&(this.labels={}),Md(this)},n.totalDuration=function(e){var t=0,n=this,r=n._last,i=fu,a,o,s;if(arguments.length)return n.timeScale((n._repeat<0?n.duration():n.totalDuration())/(n.reversed()?-e:e));if(n._dirty){for(s=n.parent;r;)a=r._prev,r._dirty&&r.totalDuration(),o=r._start,o>i&&n._sort&&r._ts&&!n._lock?(n._lock=1,Hd(n,r,o-r._delay,1)._lock=0):i=o,o<0&&r._ts&&(t-=o,(!s&&!n._dp||s&&s.smoothChildTiming)&&(n._start+=md(o/n._ts),n._time-=o,n._tTime-=o),n.shiftChildren(-o,!1,-1/0),i=0),r._end>t&&r._ts&&(t=r._end),r=a;Yd(n,n===zu&&n._time>t?n._time:t,1,1),n._dirty=0}return n._tDur},t.updateRoot=function(e){if(zu._ts&&(yd(zu,Rd(e,zu)),rd=Bf.frame),Bf.frame>=od){od+=su.autoSleep||120;var t=zu._first;if((!t||!t._ts)&&su.autoSleep&&Bf._listeners.length<2){for(;t&&!t._ts;)t=t._next;t||Bf.sleep()}}},t}(ep);Sd(tp.prototype,{_lock:0,_hasPause:0,_forcing:0});var np=function(e,t,n,r,i,a,o){var s=new kp(this._pt,e,t,0,1,Cp,null,i),c=0,l=0,u,d,f,p,m,h,g,_;for(s.b=n,s.e=r,n+=``,r+=``,(g=~r.indexOf(`random(`))&&(r=xf(r)),a&&(_=[n,r],a(_,e,t),n=_[0],r=_[1]),d=n.match(Fu)||[];u=Fu.exec(r);)p=u[0],m=r.substring(c,u.index),f?f=(f+1)%5:m.substr(-5)===`rgba(`&&(f=1),p!==d[l++]&&(h=parseFloat(d[l-1])||0,s._pt={_next:s._pt,p:m||l===1?m:`,`,s:h,c:p.charAt(1)===`=`?hd(h,p)-h:parseFloat(p)-h,m:f&&f<4?Math.round:0},c=Fu.lastIndex);return s.c=c<r.length?r.substring(c,r.length):``,s.fp=o,(Iu.test(r)||g)&&(s.e=0),this._pt=s,s},rp=function(e,t,n,r,i,a,o,s,c,l){xu(r)&&(r=r(i||0,e,a));var u=e[t],d=n===`get`?xu(u)?c?e[t.indexOf(`set`)||!xu(e[`get`+t.substr(3)])?t:`get`+t.substr(3)](c):e[t]():u:n,f=xu(u)?c?vp:_p:gp,p;if(bu(r)&&(~r.indexOf(`random(`)&&(r=xf(r)),r.charAt(1)===`=`&&(p=hd(d,r)+(nf(d)||0),(p||p===0)&&(r=p))),!l||d!==r||sp)return!isNaN(d*r)&&r!==``?(p=new kp(this._pt,e,t,+d||0,r-(d||0),typeof u==`boolean`?Sp:xp,0,f),c&&(p.fp=c),o&&p.modifier(o,this,e),this._pt=p):(!u&&!(t in e)&&qu(t,r),np.call(this,e,t,d,r,f,s||su.stringFilter,c))},ip=function(e,t,n,r,i){if(xu(e)&&(e=fp(e,i,t,n,r)),!wu(e)||e.style&&e.nodeType||ku(e)||Ou(e))return bu(e)?fp(e,i,t,n,r):e;var a={},o;for(o in e)a[o]=fp(e[o],i,t,n,r);return a},ap=function(e,t,n,r,i,a){var o,s,c,l;if(id[e]&&(o=new id[e]).init(i,o.rawVars?t[e]:ip(t[e],r,i,a,n),n,r,a)!==!1&&(n._pt=s=new kp(n._pt,i,e,0,1,o.render,o,0,o.priority),n!==Df))for(c=n._ptLookup[n._targets.indexOf(i)],l=o._props.length;l--;)c[o._props[l]]=s;return o},op,sp,cp=function e(t,n,r){var i=t.vars,a=i.ease,o=i.startAt,s=i.immediateRender,c=i.lazy,l=i.onUpdate,u=i.runBackwards,d=i.yoyoEase,f=i.keyframes,p=i.autoRevert,m=t._dur,h=t._startAt,g=t._targets,_=t.parent,v=_&&_.data===`nested`?_.vars.targets:g,y=t._overwrite===`auto`&&!lu,b=t.timeline,x=i.easeReverse||d,S,C,w,T,E,D,O,k,A,j,M,N,P;if(b&&(!f||!a)&&(a=`none`),t._ease=Jf(a,cu.ease),t._rEase=x&&(Jf(x)||t._ease),t._from=!b&&!!i.runBackwards,t._from&&(t.ratio=1),!b||f&&!i.stagger){if(k=g[0]?ud(g[0]).harness:0,N=k&&i[k.prop],S=Ed(i,ed),h&&(h._zTime<0&&h.progress(1),n<0&&u&&s&&!p?h.render(-1,!0):h.revert(u&&m?Qu:Zu),h._lazy=0),o){if(jd(t._startAt=hp.set(g,Sd({data:`isStart`,overwrite:!1,parent:_,immediateRender:!0,lazy:!h&&Tu(c),startAt:null,delay:0,onUpdate:l&&function(){return Tf(t,`onUpdate`)},stagger:0},o))),t._startAt._dp=0,t._startAt._sat=t,n<0&&(uu||!s&&!p)&&t._startAt.revert(Qu),s&&m&&n<=0&&r<=0){n&&(t._zTime=n);return}}else if(u&&m&&!h){if(n&&(s=!1),w=Sd({overwrite:!1,data:`isFromStart`,lazy:s&&!h&&Tu(c),immediateRender:s,stagger:0,parent:_},S),N&&(w[k.prop]=N),jd(t._startAt=hp.set(g,w)),t._startAt._dp=0,t._startAt._sat=t,n<0&&(uu?t._startAt.revert(Qu):t._startAt.render(-1,!0)),t._zTime=n,!s)e(t._startAt,pu,pu);else if(!n)return}for(t._pt=t._ptCache=0,c=m&&Tu(c)||c&&!m,C=0;C<g.length;C++){if(E=g[C],O=E._gsap||ld(g)[C]._gsap,t._ptLookup[C]=j={},nd[O.id]&&td.length&&_d(),M=v===g?C:v.indexOf(E),k&&(A=new k).init(E,N||S,t,M,v)!==!1&&(t._pt=T=new kp(t._pt,E,A.name,0,1,A.render,A,0,A.priority),A._props.forEach(function(e){j[e]=T}),A.priority&&(D=1)),!k||N)for(w in S)id[w]&&(A=ap(w,S,t,M,E,v))?A.priority&&(D=1):j[w]=T=rp.call(t,E,w,`get`,S[w],M,v,0,i.stringFilter);t._op&&t._op[C]&&t.kill(E,t._op[C]),y&&t._pt&&(op=t,zu.killTweensOf(E,j,t.globalTime(n)),P=!t.parent,op=0),t._pt&&c&&(nd[O.id]=1)}D&&Op(t),t._onInit&&t._onInit(t)}t._onUpdate=l,t._initted=(!t._op||t._pt)&&!P,f&&n<=0&&b.render(fu,!0,!0)},lp=function(e,t,n,r,i,a,o,s){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],l,u,d,f;if(!c)for(c=e._ptCache[t]=[],d=e._ptLookup,f=e._targets.length;f--;){if(l=d[f][t],l&&l.d&&l.d._pt)for(l=l.d._pt;l&&l.p!==t&&l.fp!==t;)l=l._next;if(!l)return sp=1,e.vars[t]=`+=0`,cp(e,o),sp=0,s?Ju(t+` not eligible for reset. Try splitting into individual properties`):1;c.push(l)}for(f=c.length;f--;)u=c[f],l=u._pt||u,l.s=(r||r===0)&&!i?r:l.s+(r||0)+a*l.c,l.c=n-l.s,u.e&&=pd(n)+nf(u.e),u.b&&=l.s+nf(u.b)},up=function(e,t){var n=e[0]?ud(e[0]).harness:0,r=n&&n.aliases,i,a,o,s;if(!r)return t;for(a in i=wd({},t),r)if(a in i)for(s=r[a].split(`,`),o=s.length;o--;)i[s[o]]=i[a];return i},dp=function(e,t,n,r){var i=t.ease||r||`power1.inOut`,a,o;if(ku(t))o=n[e]||(n[e]=[]),t.forEach(function(e,n){return o.push({t:n/(t.length-1)*100,v:e,e:i})});else for(a in t)o=n[a]||(n[a]=[]),a===`ease`||o.push({t:parseFloat(e),v:t[a],e:i})},fp=function(e,t,n,r,i){return xu(e)?e.call(t,n,r,i):bu(e)&&~e.indexOf(`random(`)?xf(e):e},pp=cd+`repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert`,mp={};fd(pp+`,id,stagger,delay,duration,paused,scrollTrigger`,function(e){return mp[e]=1});var hp=function(e){ou(t,e);function t(t,n,r,i){var a;typeof n==`number`&&(r.duration=n,n=r,r=null),a=e.call(this,i?n:Dd(n))||this;var o=a.vars,s=o.duration,c=o.delay,l=o.immediateRender,u=o.stagger,d=o.overwrite,f=o.keyframes,p=o.defaults,m=o.scrollTrigger,h=n.parent||zu,g=(ku(t)||Ou(t)?Su(t[0]):`length`in n)?[t]:cf(t),_,v,y,b,x,S,C,w;if(a._targets=g.length?ld(g):Ju(`GSAP target `+t+` not found. https://gsap.com`,!su.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=d,f||u||Du(s)||Du(c)){n=a.vars;var T=n.easeReverse||n.yoyoEase;if(_=a.timeline=new tp({data:`nested`,defaults:p||{},targets:h&&h.data===`nested`?h.vars.targets:g}),_.kill(),_.parent=_._dp=au(a),_._start=0,u||Du(s)||Du(c)){if(b=g.length,C=u&&df(u),wu(u))for(x in u)~pp.indexOf(x)&&(w||={},w[x]=u[x]);for(v=0;v<b;v++)y=Ed(n,mp),y.stagger=0,T&&(y.easeReverse=T),w&&wd(y,w),S=g[v],y.duration=+fp(s,au(a),v,S,g),y.delay=(+fp(c,au(a),v,S,g)||0)-a._delay,!u&&b===1&&y.delay&&(a._delay=c=y.delay,a._start+=c,y.delay=0),_.to(S,y,C?C(v,S,g):0),_._ease=$.none;_.duration()?s=c=0:a.timeline=0}else if(f){Dd(Sd(_.vars.defaults,{ease:`none`})),_._ease=Jf(f.ease||n.ease||`none`);var E=0,D,O,k;if(ku(f))f.forEach(function(e){return _.to(g,e,`>`)}),_.duration();else{for(x in y={},f)x===`ease`||x===`easeEach`||dp(x,f[x],y,f.easeEach);for(x in y)for(D=y[x].sort(function(e,t){return e.t-t.t}),E=0,v=0;v<D.length;v++)O=D[v],k={ease:O.e,duration:(O.t-(v?D[v-1].t:0))/100*s},k[x]=O.v,_.to(g,k,E),E+=k.duration;_.duration()<s&&_.to({},{duration:s-_.duration()})}}s||a.duration(s=_.duration())}else a.timeline=0;return d===!0&&!lu&&(op=au(a),zu.killTweensOf(g),op=0),Hd(h,au(a),r),n.reversed&&a.reverse(),n.paused&&a.paused(!0),(l||!s&&!f&&a._start===md(h._time)&&Tu(l)&&Fd(au(a))&&h.data!==`nested`)&&(a._tTime=-pu,a.render(Math.max(0,-c)||0)),m&&Ud(au(a),m),a}var n=t.prototype;return n.render=function(e,t,n){var r=this._time,i=this._tDur,a=this._dur,o=e<0,s=e>i-pu&&!o?i:e<pu?0:e,c,l,u,d,f,p,m,h;if(!a)qd(this,e,t,n);else if(s!==this._tTime||!e||n||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==o||this._lazy){if(c=s,h=this.timeline,this._repeat){if(d=a+this._rDelay,this._repeat<-1&&o)return this.totalTime(d*100+e,t,n);if(c=md(s%d),s===i?(u=this._repeat,c=a):(f=md(s/d),u=~~f,u&&u===f?(c=a,u--):c>a&&(c=a)),p=this._yoyo&&u&1,p&&(c=a-c),f=Ld(this._tTime,d),c===r&&!n&&this._initted&&u===f)return this._tTime=s,this;u!==f&&this.vars.repeatRefresh&&!p&&!this._lock&&c!==d&&this._initted&&(this._lock=n=1,this.render(md(d*u),!0).invalidate()._lock=0)}if(!this._initted){if(Wd(this,o?e:c,n,t,s))return this._tTime=0,this;if(r!==this._time&&!(n&&this.vars.repeatRefresh&&u!==f))return this;if(a!==this._dur)return this.render(e,t,n)}if(this._rEase){var g=c<r;if(g!==this._inv){var _=g?r:a-r;this._inv=g,this._from&&(this.ratio=1-this.ratio),this._invRatio=this.ratio,this._invTime=r,this._invRecip=_?(g?-1:1)/_:0,this._invScale=g?-this.ratio:1-this.ratio,this._invEase=g?this._rEase:this._ease}this.ratio=m=this._invRatio+this._invScale*this._invEase((c-this._invTime)*this._invRecip)}else this.ratio=m=this._ease(c/a);if(this._from&&(this.ratio=m=1-m),this._tTime=s,this._time=c,!this._act&&this._ts&&(this._act=1,this._lazy=0),!r&&s&&!t&&!f&&(Tf(this,`onStart`),this._tTime!==s))return this;for(l=this._pt;l;)l.r(m,l.d),l=l._next;h&&h.render(e<0?e:h._dur*h._ease(c/this._dur),t,n)||this._startAt&&(this._zTime=e),this._onUpdate&&!t&&(o&&Pd(this,e,t,n),Tf(this,`onUpdate`)),this._repeat&&u!==f&&this.vars.onRepeat&&!t&&this.parent&&Tf(this,`onRepeat`),(s===this._tDur||!s)&&this._tTime===s&&(o&&!this._onUpdate&&Pd(this,e,!0,!0),(e||!a)&&(s===this._tDur&&this._ts>0||!s&&this._ts<0)&&jd(this,1),!t&&!(o&&!r)&&(s||r||p)&&(Tf(this,s===i?`onComplete`:`onReverseComplete`,!0),this._prom&&!(s<i&&this.timeScale()>0)&&this._prom()))}return this},n.targets=function(){return this._targets},n.invalidate=function(t){return(!t||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(t),e.prototype.invalidate.call(this,t)},n.resetTo=function(e,t,n,r,i){zf||Bf.wake(),this._ts||this.play();var a=Math.min(this._dur,(this._dp._time-this._start)*this._ts),o;return this._initted||cp(this,a),o=this._ease(a/this._dur),lp(this,e,t,n,r,o,a,i)?this.resetTo(e,t,n,r,1):(Bd(this,0),this.parent||kd(this._dp,this,`_first`,`_last`,this._dp._sort?`_start`:0),this.render(0))},n.kill=function(e,t){if(t===void 0&&(t=`all`),!e&&(!t||t===`all`))return this._lazy=this._pt=0,this.parent?Ef(this):this.scrollTrigger&&this.scrollTrigger.kill(!!uu),this;if(this.timeline){var n=this.timeline.totalDuration();return this.timeline.killTweensOf(e,t,op&&op.vars.overwrite!==!0)._first||Ef(this),this.parent&&n!==this.timeline.totalDuration()&&Yd(this,this._dur*this.timeline._tDur/n,0,1),this}var r=this._targets,i=e?cf(e):r,a=this._ptLookup,o=this._pt,s,c,l,u,d,f,p;if((!t||t===`all`)&&Od(r,i))return t===`all`&&(this._pt=0),Ef(this);for(s=this._op=this._op||[],t!==`all`&&(bu(t)&&(d={},fd(t,function(e){return d[e]=1}),t=d),t=up(r,t)),p=r.length;p--;)if(~i.indexOf(r[p]))for(d in c=a[p],t===`all`?(s[p]=t,u=c,l={}):(l=s[p]=s[p]||{},u=t),u)f=c&&c[d],f&&((!(`kill`in f.d)||f.d.kill(d)===!0)&&Ad(this,f,`_pt`),delete c[d]),l!==`all`&&(l[d]=1);return this._initted&&!this._pt&&o&&Ef(this),this},t.to=function(e,n){return new t(e,n,arguments[2])},t.from=function(e,t){return $d(1,arguments)},t.delayedCall=function(e,n,r,i){return new t(n,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:e,onComplete:n,onReverseComplete:n,onCompleteParams:r,onReverseCompleteParams:r,callbackScope:i})},t.fromTo=function(e,t,n){return $d(2,arguments)},t.set=function(e,n){return n.duration=0,n.repeatDelay||(n.repeat=0),new t(e,n)},t.killTweensOf=function(e,t,n){return zu.killTweensOf(e,t,n)},t}(ep);Sd(hp.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0}),fd(`staggerTo,staggerFrom,staggerFromTo`,function(e){hp[e]=function(){var t=new tp,n=af.call(arguments,0);return n.splice(e===`staggerFromTo`?5:4,0,0),t[e].apply(t,n)}});var gp=function(e,t,n){return e[t]=n},_p=function(e,t,n){return e[t](n)},vp=function(e,t,n,r){return e[t](r.fp,n)},yp=function(e,t,n){return e.setAttribute(t,n)},bp=function(e,t){return xu(e[t])?_p:Cu(e[t])&&e.setAttribute?yp:gp},xp=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},Sp=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},Cp=function(e,t){var n=t._pt,r=``;if(!e&&t.b)r=t.b;else if(e===1&&t.e)r=t.e;else{for(;n;)r=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+r,n=n._next;r+=t.c}t.set(t.t,t.p,r,t)},wp=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},Tp=function(e,t,n,r){for(var i=this._pt,a;i;)a=i._next,i.p===r&&i.modifier(e,t,n),i=a},Ep=function(e){for(var t=this._pt,n,r;t;)r=t._next,t.p===e&&!t.op||t.op===e?Ad(this,t,`_pt`):t.dep||(n=1),t=r;return!n},Dp=function(e,t,n,r){r.mSet(e,t,r.m.call(r.tween,n,r.mt),r)},Op=function(e){for(var t=e._pt,n,r,i,a;t;){for(n=t._next,r=i;r&&r.pr>t.pr;)r=r._next;(t._prev=r?r._prev:a)?t._prev._next=t:i=t,(t._next=r)?r._prev=t:a=t,t=n}e._pt=i},kp=function(){function e(e,t,n,r,i,a,o,s,c){this.t=t,this.s=r,this.c=i,this.p=n,this.r=a||xp,this.d=o||this,this.set=s||gp,this.pr=c||0,this._next=e,e&&(e._prev=this)}var t=e.prototype;return t.modifier=function(e,t,n){this.mSet=this.mSet||this.set,this.set=Dp,this.m=e,this.mt=n,this.tween=t},e}();fd(cd+`parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse`,function(e){return ed[e]=1}),Uu.TweenMax=Uu.TweenLite=hp,Uu.TimelineLite=Uu.TimelineMax=tp,zu=new tp({sortChildren:!1,defaults:cu,autoRemoveChildren:!0,id:`root`,smoothChildTiming:!0}),su.stringFilter=Rf;var Ap=[],jp={},Mp=[],Np=0,Pp=0,Fp=function(e){return(jp[e]||Mp).map(function(e){return e()})},Ip=function(){var e=Date.now(),t=[];e-Np>2&&(Fp(`matchMediaInit`),Ap.forEach(function(e){var n=e.queries,r=e.conditions,i,a,o,s;for(a in n)i=Bu.matchMedia(n[a]).matches,i&&(o=1),i!==r[a]&&(r[a]=i,s=1);s&&(e.revert(),o&&t.push(e))}),Fp(`matchMediaRevert`),t.forEach(function(e){return e.onMatch(e,function(t){return e.add(null,t)})}),Np=e,Fp(`matchMedia`))},Lp=function(){function e(e,t){this.selector=t&&lf(t),this.data=[],this._r=[],this.isReverted=!1,this.id=Pp++,e&&this.add(e)}var t=e.prototype;return t.add=function(e,t,n){xu(e)&&(n=t,t=e,e=xu);var r=this,i=function(){var e=du,i=r.selector,a;return e&&e!==r&&e.data.push(r),n&&(r.selector=lf(n)),du=r,a=t.apply(r,arguments),xu(a)&&r._r.push(a),du=e,r.selector=i,r.isReverted=!1,a};return r.last=i,e===xu?i(r,function(e){return r.add(null,e)}):e?r[e]=i:i},t.ignore=function(e){var t=du;du=null,e(this),du=t},t.getTweens=function(){var t=[];return this.data.forEach(function(n){return n instanceof e?t.push.apply(t,n.getTweens()):n instanceof hp&&!(n.parent&&n.parent.data===`nested`)&&t.push(n)}),t},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(e,t){var n=this;if(e?(function(){for(var t=n.getTweens(),r=n.data.length,i;r--;)i=n.data[r],i.data===`isFlip`&&(i.revert(),i.getChildren(!0,!0,!1).forEach(function(e){return t.splice(t.indexOf(e),1)}));for(t.map(function(e){return{g:e._dur||e._delay||e._sat&&!e._sat.vars.immediateRender?e.globalTime(0):-1/0,t:e}}).sort(function(e,t){return t.g-e.g||-1/0}).forEach(function(t){return t.t.revert(e)}),r=n.data.length;r--;)i=n.data[r],i instanceof tp?i.data!==`nested`&&(i.scrollTrigger&&i.scrollTrigger.revert(),i.kill()):!(i instanceof hp)&&i.revert&&i.revert(e);n._r.forEach(function(t){return t(e,n)}),n.isReverted=!0})():this.data.forEach(function(e){return e.kill&&e.kill()}),this.clear(),t)for(var r=Ap.length;r--;)Ap[r].id===this.id&&Ap.splice(r,1)},t.revert=function(e){this.kill(e||{})},e}(),Rp=function(){function e(e){this.contexts=[],this.scope=e,du&&du.data.push(this)}var t=e.prototype;return t.add=function(e,t,n){wu(e)||(e={matches:e});var r=new Lp(0,n||this.scope),i=r.conditions={},a,o,s;for(o in du&&!r.selector&&(r.selector=du.selector),this.contexts.push(r),t=r.add(`onMatch`,t),r.queries=e,e)o===`all`?s=1:(a=Bu.matchMedia(e[o]),a&&(Ap.indexOf(r)<0&&Ap.push(r),(i[o]=a.matches)&&(s=1),a.addListener?a.addListener(Ip):a.addEventListener(`change`,Ip)));return s&&t(r,function(e){return r.add(null,e)}),this},t.revert=function(e){this.kill(e||{})},t.kill=function(e){this.contexts.forEach(function(t){return t.kill(e,!0)})},e}(),zp={registerPlugin:function(){[...arguments].forEach(function(e){return kf(e)})},timeline:function(e){return new tp(e)},getTweensOf:function(e,t){return zu.getTweensOf(e,t)},getProperty:function(e,t,n,r){bu(e)&&(e=cf(e)[0]);var i=ud(e||{}).get,a=n?xd:bd;return n===`native`&&(n=``),e&&(t?a((id[t]&&id[t].get||i)(e,t,n,r)):function(t,n,r){return a((id[t]&&id[t].get||i)(e,t,n,r))})},quickSetter:function(e,t,n){if(e=cf(e),e.length>1){var r=e.map(function(e){return Up.quickSetter(e,t,n)}),i=r.length;return function(e){for(var t=i;t--;)r[t](e)}}e=e[0]||{};var a=id[t],o=ud(e),s=o.harness&&(o.harness.aliases||{})[t]||t,c=a?function(t){var r=new a;Df._pt=0,r.init(e,n?t+n:t,Df,0,[e]),r.render(1,r),Df._pt&&wp(1,Df)}:o.set(e,s);return a?c:function(t){return c(e,s,n?t+n:t,o,1)}},quickTo:function(e,t,n){var r,i=Up.to(e,Sd((r={},r[t]=`+=0.1`,r.paused=!0,r.stagger=0,r),n||{})),a=function(e,n,r){return i.resetTo(t,e,n,r)};return a.tween=i,a},isTweening:function(e){return zu.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=Jf(e.ease,cu.ease)),Td(cu,e||{})},config:function(e){return Td(su,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,r=e.plugins,i=e.defaults,a=e.extendTimeline;(r||``).split(`,`).forEach(function(e){return e&&!id[e]&&!Uu[e]&&Ju(t+` effect requires `+e+` plugin.`)}),ad[t]=function(e,t,r){return n(cf(e),Sd(t||{},i),r)},a&&(tp.prototype[t]=function(e,n,r){return this.add(ad[t](e,wu(n)?n:(r=n)&&{},this),r)})},registerEase:function(e,t){$[e]=Jf(t)},parseEase:function(e,t){return arguments.length?Jf(e,t):$},getById:function(e){return zu.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new tp(e),r,i;for(n.smoothChildTiming=Tu(e.smoothChildTiming),zu.remove(n),n._dp=0,n._time=n._tTime=zu._time,r=zu._first;r;)i=r._next,(t||!(!r._dur&&r instanceof hp&&r.vars.onComplete===r._targets[0]))&&Hd(n,r,r._start-r._delay),r=i;return Hd(zu,n,0),n},context:function(e,t){return e?new Lp(e,t):du},matchMedia:function(e){return new Rp(e)},matchMediaRefresh:function(){return Ap.forEach(function(e){var t=e.conditions,n,r;for(r in t)t[r]&&(t[r]=!1,n=1);n&&e.revert()})||Ip()},addEventListener:function(e,t){var n=jp[e]||(jp[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=jp[e],r=n&&n.indexOf(t);r>=0&&n.splice(r,1)},utils:{wrap:yf,wrapYoyo:bf,distribute:df,random:mf,snap:pf,normalize:_f,getUnit:nf,clamp:rf,splitColor:Nf,toArray:cf,selector:lf,mapRange:Sf,pipe:hf,unitize:gf,interpolate:Cf,shuffle:uf},install:Ku,effects:ad,ticker:Bf,updateRoot:tp.updateRoot,plugins:id,globalTimeline:zu,core:{PropTween:kp,globals:Yu,Tween:hp,Timeline:tp,Animation:ep,getCache:ud,_removeLinkedListItem:Ad,reverting:function(){return uu},context:function(e){return e&&du&&(du.data.push(e),e._ctx=du),du},suppressOverwrites:function(e){return lu=e}}};fd(`to,from,fromTo,delayedCall,set,killTweensOf`,function(e){return zp[e]=hp[e]}),Bf.add(tp.updateRoot),Df=zp.to({},{duration:0});var Bp=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},Vp=function(e,t){var n=e._targets,r,i,a;for(r in t)for(i=n.length;i--;)a=e._ptLookup[i][r],(a&&=a.d)&&(a._pt&&(a=Bp(a,r)),a&&a.modifier&&a.modifier(t[r],e,n[i],r))},Hp=function(e,t){return{name:e,headless:1,rawVars:1,init:function(e,n,r){r._onInit=function(e){var r,i;if(bu(n)&&(r={},fd(n,function(e){return r[e]=1}),n=r),t){for(i in r={},n)r[i]=t(n[i]);n=r}Vp(e,n)}}}},Up=zp.registerPlugin({name:`attr`,init:function(e,t,n,r,i){var a,o,s;for(a in this.tween=n,t)s=e.getAttribute(a)||``,o=this.add(e,`setAttribute`,(s||0)+``,t[a],r,i,0,0,a),o.op=a,o.b=s,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)uu?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:`endArray`,headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},Hp(`roundProps`,ff),Hp(`modifiers`),Hp(`snap`,pf))||zp;hp.version=tp.version=Up.version=`3.15.0`,Gu=1,Eu()&&Vf(),$.Power0,$.Power1,$.Power2,$.Power3,$.Power4,$.Linear,$.Quad,$.Cubic,$.Quart,$.Quint,$.Strong,$.Elastic,$.Back,$.SteppedEase,$.Bounce,$.Sine,$.Expo,$.Circ;var Wp,Gp,Kp,qp,Jp,Yp,Xp,Zp=function(){return typeof window<`u`},Qp={},$p=180/Math.PI,em=Math.PI/180,tm=Math.atan2,nm=1e8,rm=/([A-Z])/g,im=/(left|right|width|margin|padding|x)/i,am=/[\s,\(]\S/,om={autoAlpha:`opacity,visibility`,scale:`scaleX,scaleY`,alpha:`opacity`},sm=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},cm=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},lm=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},um=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},dm=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},fm=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},pm=function(e,t){return t.set(t.t,t.p,e===1?t.e:t.b,t)},mm=function(e,t,n){return e.style[t]=n},hm=function(e,t,n){return e.style.setProperty(t,n)},gm=function(e,t,n){return e._gsap[t]=n},_m=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},vm=function(e,t,n,r,i){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(i,a)},ym=function(e,t,n,r,i){var a=e._gsap;a[t]=n,a.renderTransform(i,a)},bm=`transform`,xm=bm+`Origin`,Sm=function e(t,n){var r=this,i=this.target,a=i.style,o=i._gsap;if(t in Qp&&a){if(this.tfm=this.tfm||{},t!==`transform`)t=om[t]||t,~t.indexOf(`,`)?t.split(`,`).forEach(function(e){return r.tfm[e]=Vm(i,e)}):this.tfm[t]=o.x?o[t]:Vm(i,t),t===xm&&(this.tfm.zOrigin=o.zOrigin);else return om.transform.split(`,`).forEach(function(t){return e.call(r,t,n)});if(this.props.indexOf(bm)>=0)return;o.svg&&(this.svgo=i.getAttribute(`data-svg-origin`),this.props.push(xm,n,``)),t=bm}(a||n)&&this.props.push(t,n,a[t])},Cm=function(e){e.translate&&(e.removeProperty(`translate`),e.removeProperty(`scale`),e.removeProperty(`rotate`))},wm=function(){var e=this.props,t=this.target,n=t.style,r=t._gsap,i,a;for(i=0;i<e.length;i+=3)e[i+1]?e[i+1]===2?t[e[i]](e[i+2]):t[e[i]]=e[i+2]:e[i+2]?n[e[i]]=e[i+2]:n.removeProperty(e[i].substr(0,2)===`--`?e[i]:e[i].replace(rm,`-$1`).toLowerCase());if(this.tfm){for(a in this.tfm)r[a]=this.tfm[a];r.svg&&(r.renderTransform(),t.setAttribute(`data-svg-origin`,this.svgo||``)),i=Xp(),(!i||!i.isStart)&&!n[bm]&&(Cm(n),r.zOrigin&&n[xm]&&(n[xm]+=` `+r.zOrigin+`px`,r.zOrigin=0,r.renderTransform()),r.uncache=1)}},Tm=function(e,t){var n={target:e,props:[],revert:wm,save:Sm};return e._gsap||Up.core.getCache(e),t&&e.style&&e.nodeType&&t.split(`,`).forEach(function(e){return n.save(e)}),n},Em,Dm=function(e,t){var n=Gp.createElementNS?Gp.createElementNS((t||`http://www.w3.org/1999/xhtml`).replace(/^https/,`http`),e):Gp.createElement(e);return n&&n.style?n:Gp.createElement(e)},Om=function e(t,n,r){var i=getComputedStyle(t);return i[n]||i.getPropertyValue(n.replace(rm,`-$1`).toLowerCase())||i.getPropertyValue(n)||!r&&e(t,Am(n)||n,1)||``},km=`O,Moz,ms,Ms,Webkit`.split(`,`),Am=function(e,t,n){var r=(t||Jp).style,i=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);i--&&!(km[i]+e in r););return i<0?null:(i===3?`ms`:i>=0?km[i]:``)+e},jm=function(){Zp()&&window.document&&(Wp=window,Gp=Wp.document,Kp=Gp.documentElement,Jp=Dm(`div`)||{style:{}},Dm(`div`),bm=Am(bm),xm=bm+`Origin`,Jp.style.cssText=`border-width:0;line-height:0;position:absolute;padding:0`,Em=!!Am(`perspective`),Xp=Up.core.reverting,qp=1)},Mm=function(e){var t=e.ownerSVGElement,n=Dm(`svg`,t&&t.getAttribute(`xmlns`)||`http://www.w3.org/2000/svg`),r=e.cloneNode(!0),i;r.style.display=`block`,n.appendChild(r),Kp.appendChild(n);try{i=r.getBBox()}catch{}return n.removeChild(r),Kp.removeChild(n),i},Nm=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Pm=function(e){var t,n;try{t=e.getBBox()}catch{t=Mm(e),n=1}return t&&(t.width||t.height)||n||(t=Mm(e)),t&&!t.width&&!t.x&&!t.y?{x:+Nm(e,[`x`,`cx`,`x1`])||0,y:+Nm(e,[`y`,`cy`,`y1`])||0,width:0,height:0}:t},Fm=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Pm(e))},Im=function(e,t){if(t){var n=e.style,r;t in Qp&&t!==xm&&(t=bm),n.removeProperty?(r=t.substr(0,2),(r===`ms`||t.substr(0,6)===`webkit`)&&(t=`-`+t),n.removeProperty(r===`--`?t:t.replace(rm,`-$1`).toLowerCase())):n.removeAttribute(t)}},Lm=function(e,t,n,r,i,a){var o=new kp(e._pt,t,n,0,1,a?pm:fm);return e._pt=o,o.b=r,o.e=i,e._props.push(n),o},Rm={deg:1,rad:1,turn:1},zm={grid:1,flex:1},Bm=function e(t,n,r,i){var a=parseFloat(r)||0,o=(r+``).trim().substr((a+``).length)||`px`,s=Jp.style,c=im.test(n),l=t.tagName.toLowerCase()===`svg`,u=(l?`client`:`offset`)+(c?`Width`:`Height`),d=100,f=i===`px`,p=i===`%`,m,h,g,_;if(i===o||!a||Rm[i]||Rm[o])return a;if(o!==`px`&&!f&&(a=e(t,n,r,`px`)),_=t.getCTM&&Fm(t),(p||o===`%`)&&(Qp[n]||~n.indexOf(`adius`)))return m=_?t.getBBox()[c?`width`:`height`]:t[u],pd(p?a/m*d:a/100*m);if(s[c?`width`:`height`]=d+(f?o:i),h=i!==`rem`&&~n.indexOf(`adius`)||i===`em`&&t.appendChild&&!l?t:t.parentNode,_&&(h=(t.ownerSVGElement||{}).parentNode),(!h||h===Gp||!h.appendChild)&&(h=Gp.body),g=h._gsap,g&&p&&g.width&&c&&g.time===Bf.time&&!g.uncache)return pd(a/g.width*d);if(p&&(n===`height`||n===`width`)){var v=t.style[n];t.style[n]=d+i,m=t[u],v?t.style[n]=v:Im(t,n)}else (p||o===`%`)&&!zm[Om(h,`display`)]&&(s.position=Om(t,`position`)),h===t&&(s.position=`static`),h.appendChild(Jp),m=Jp[u],h.removeChild(Jp),s.position=`absolute`;return c&&p&&(g=ud(h),g.time=Bf.time,g.width=h[u]),pd(f?m*a/d:m&&a?d/m*a:0)},Vm=function(e,t,n,r){var i;return qp||jm(),t in om&&t!==`transform`&&(t=om[t],~t.indexOf(`,`)&&(t=t.split(`,`)[0])),Qp[t]&&t!==`transform`?(i=$m(e,r),i=t===`transformOrigin`?i.svg?i.origin:eh(Om(e,xm))+` `+i.zOrigin+`px`:i[t]):(i=e.style[t],(!i||i===`auto`||r||~(i+``).indexOf(`calc(`))&&(i=Km[t]&&Km[t](e,t,n)||Om(e,t)||dd(e,t)||+(t===`opacity`))),n&&!~(i+``).trim().indexOf(` `)?Bm(e,t,i,n)+n:i},Hm=function(e,t,n,r){if(!n||n===`none`){var i=Am(t,e,1),a=i&&Om(e,i,1);a&&a!==n?(t=i,n=a):t===`borderColor`&&(n=Om(e,`borderTopColor`))}var o=new kp(this._pt,e.style,t,0,1,Cp),s=0,c=0,l,u,d,f,p,m,h,g,_,v,y,b;if(o.b=n,o.e=r,n+=``,r+=``,r.substring(0,6)===`var(--`&&(r=Om(e,r.substring(4,r.indexOf(`)`)))),r===`auto`&&(m=e.style[t],e.style[t]=r,r=Om(e,t)||r,m?e.style[t]=m:Im(e,t)),l=[n,r],Rf(l),n=l[0],r=l[1],d=n.match(Pu)||[],b=r.match(Pu)||[],b.length){for(;u=Pu.exec(r);)h=u[0],_=r.substring(s,u.index),p?p=(p+1)%5:(_.substr(-5)===`rgba(`||_.substr(-5)===`hsla(`)&&(p=1),h!==(m=d[c++]||``)&&(f=parseFloat(m)||0,y=m.substr((f+``).length),h.charAt(1)===`=`&&(h=hd(f,h)+y),g=parseFloat(h),v=h.substr((g+``).length),s=Pu.lastIndex-v.length,v||(v=v||su.units[t]||y,s===r.length&&(r+=v,o.e+=v)),y!==v&&(f=Bm(e,t,m,v)||0),o._pt={_next:o._pt,p:_||c===1?_:`,`,s:f,c:g-f,m:p&&p<4||t===`zIndex`?Math.round:0});o.c=s<r.length?r.substring(s,r.length):``}else o.r=t===`display`&&r===`none`?pm:fm;return Iu.test(r)&&(o.e=0),this._pt=o,o},Um={top:`0%`,bottom:`100%`,left:`0%`,right:`100%`,center:`50%`},Wm=function(e){var t=e.split(` `),n=t[0],r=t[1]||`50%`;return(n===`top`||n===`bottom`||r===`left`||r===`right`)&&(e=n,n=r,r=e),t[0]=Um[n]||n,t[1]=Um[r]||r,t.join(` `)},Gm=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,r=n.style,i=t.u,a=n._gsap,o,s,c;if(i===`all`||i===!0)r.cssText=``,s=1;else for(i=i.split(`,`),c=i.length;--c>-1;)o=i[c],Qp[o]&&(s=1,o=o===`transformOrigin`?xm:bm),Im(n,o);s&&(Im(n,bm),a&&(a.svg&&n.removeAttribute(`transform`),r.scale=r.rotate=r.translate=`none`,$m(n,1),a.uncache=1,Cm(r)))}},Km={clearProps:function(e,t,n,r,i){if(i.data!==`isFromStart`){var a=e._pt=new kp(e._pt,t,n,0,0,Gm);return a.u=r,a.pr=-10,a.tween=i,e._props.push(n),1}}},qm=[1,0,0,1,0,0],Jm={},Ym=function(e){return e===`matrix(1, 0, 0, 1, 0, 0)`||e===`none`||!e},Xm=function(e){var t=Om(e,bm);return Ym(t)?qm:t.substr(7).match(Nu).map(pd)},Zm=function(e,t){var n=e._gsap||ud(e),r=e.style,i=Xm(e),a,o,s,c;return n.svg&&e.getAttribute(`transform`)?(s=e.transform.baseVal.consolidate().matrix,i=[s.a,s.b,s.c,s.d,s.e,s.f],i.join(`,`)===`1,0,0,1,0,0`?qm:i):(i===qm&&!e.offsetParent&&e!==Kp&&!n.svg&&(s=r.display,r.display=`block`,a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(c=1,o=e.nextElementSibling,Kp.appendChild(e)),i=Xm(e),s?r.display=s:Im(e,`display`),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):Kp.removeChild(e))),t&&i.length>6?[i[0],i[1],i[4],i[5],i[12],i[13]]:i)},Qm=function(e,t,n,r,i,a){var o=e._gsap,s=i||Zm(e,!0),c=o.xOrigin||0,l=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,f=s[0],p=s[1],m=s[2],h=s[3],g=s[4],_=s[5],v=t.split(` `),y=parseFloat(v[0])||0,b=parseFloat(v[1])||0,x,S,C,w;n?s!==qm&&(S=f*h-p*m)&&(C=h/S*y+b*(-m/S)+(m*_-h*g)/S,w=y*(-p/S)+f/S*b-(f*_-p*g)/S,y=C,b=w):(x=Pm(e),y=x.x+(~v[0].indexOf(`%`)?y/100*x.width:y),b=x.y+(~(v[1]||v[0]).indexOf(`%`)?b/100*x.height:b)),r||r!==!1&&o.smooth?(g=y-c,_=b-l,o.xOffset=u+(g*f+_*m)-g,o.yOffset=d+(g*p+_*h)-_):o.xOffset=o.yOffset=0,o.xOrigin=y,o.yOrigin=b,o.smooth=!!r,o.origin=t,o.originIsAbsolute=!!n,e.style[xm]=`0px 0px`,a&&(Lm(a,o,`xOrigin`,c,y),Lm(a,o,`yOrigin`,l,b),Lm(a,o,`xOffset`,u,o.xOffset),Lm(a,o,`yOffset`,d,o.yOffset)),e.setAttribute(`data-svg-origin`,y+` `+b)},$m=function(e,t){var n=e._gsap||new $f(e);if(`x`in n&&!t&&!n.uncache)return n;var r=e.style,i=n.scaleX<0,a=`px`,o=`deg`,s=getComputedStyle(e),c=Om(e,xm)||`0`,l=u=d=m=h=g=_=v=y=0,u,d,f=p=1,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,ee,te,ne,re;return n.svg=!!(e.getCTM&&Fm(e)),s.translate&&((s.translate!==`none`||s.scale!==`none`||s.rotate!==`none`)&&(r[bm]=(s.translate===`none`?``:`translate3d(`+(s.translate+` 0 0`).split(` `).slice(0,3).join(`, `)+`) `)+(s.rotate===`none`?``:`rotate(`+s.rotate+`) `)+(s.scale===`none`?``:`scale(`+s.scale.split(` `).join(`,`)+`) `)+(s[bm]===`none`?``:s[bm])),r.scale=r.rotate=r.translate=`none`),S=Zm(e,n.svg),n.svg&&(n.uncache?(N=e.getBBox(),c=n.xOrigin-N.x+`px `+(n.yOrigin-N.y)+`px`,M=``):M=!t&&e.getAttribute(`data-svg-origin`),Qm(e,M||c,!!M||n.originIsAbsolute,n.smooth!==!1,S)),b=n.xOrigin||0,x=n.yOrigin||0,S!==qm&&(E=S[0],D=S[1],O=S[2],k=S[3],l=A=S[4],u=j=S[5],S.length===6?(f=Math.sqrt(E*E+D*D),p=Math.sqrt(k*k+O*O),m=E||D?tm(D,E)*$p:0,_=O||k?tm(O,k)*$p+m:0,_&&(p*=Math.abs(Math.cos(_*em))),n.svg&&(l-=b-(b*E+x*O),u-=x-(b*D+x*k))):(re=S[6],te=S[7],F=S[8],I=S[9],ee=S[10],ne=S[11],l=S[12],u=S[13],d=S[14],C=tm(re,ee),h=C*$p,C&&(w=Math.cos(-C),T=Math.sin(-C),M=A*w+F*T,N=j*w+I*T,P=re*w+ee*T,F=A*-T+F*w,I=j*-T+I*w,ee=re*-T+ee*w,ne=te*-T+ne*w,A=M,j=N,re=P),C=tm(-O,ee),g=C*$p,C&&(w=Math.cos(-C),T=Math.sin(-C),M=E*w-F*T,N=D*w-I*T,P=O*w-ee*T,ne=k*T+ne*w,E=M,D=N,O=P),C=tm(D,E),m=C*$p,C&&(w=Math.cos(C),T=Math.sin(C),M=E*w+D*T,N=A*w+j*T,D=D*w-E*T,j=j*w-A*T,E=M,A=N),h&&Math.abs(h)+Math.abs(m)>359.9&&(h=m=0,g=180-g),f=pd(Math.sqrt(E*E+D*D+O*O)),p=pd(Math.sqrt(j*j+re*re)),C=tm(A,j),_=Math.abs(C)>2e-4?C*$p:0,y=ne?1/(ne<0?-ne:ne):0),n.svg&&(M=e.getAttribute(`transform`),n.forceCSS=e.setAttribute(`transform`,``)||!Ym(Om(e,bm)),M&&e.setAttribute(`transform`,M))),Math.abs(_)>90&&Math.abs(_)<270&&(i?(f*=-1,_+=m<=0?180:-180,m+=m<=0?180:-180):(p*=-1,_+=_<=0?180:-180)),t||=n.uncache,n.x=l-((n.xPercent=l&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-l)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=pd(f),n.scaleY=pd(p),n.rotation=pd(m)+o,n.rotationX=pd(h)+o,n.rotationY=pd(g)+o,n.skewX=_+o,n.skewY=v+o,n.transformPerspective=y+a,(n.zOrigin=parseFloat(c.split(` `)[2])||!t&&n.zOrigin||0)&&(r[xm]=eh(c)),n.xOffset=n.yOffset=0,n.force3D=su.force3D,n.renderTransform=n.svg?sh:Em?oh:nh,n.uncache=0,n},eh=function(e){return(e=e.split(` `))[0]+` `+e[1]},th=function(e,t,n){var r=nf(t);return pd(parseFloat(t)+parseFloat(Bm(e,`x`,n+`px`,r)))+r},nh=function(e,t){t.z=`0px`,t.rotationY=t.rotationX=`0deg`,t.force3D=0,oh(e,t)},rh=`0deg`,ih=`0px`,ah=`) `,oh=function(e,t){var n=t||this,r=n.xPercent,i=n.yPercent,a=n.x,o=n.y,s=n.z,c=n.rotation,l=n.rotationY,u=n.rotationX,d=n.skewX,f=n.skewY,p=n.scaleX,m=n.scaleY,h=n.transformPerspective,g=n.force3D,_=n.target,v=n.zOrigin,y=``,b=g===`auto`&&e&&e!==1||g===!0;if(v&&(u!==rh||l!==rh)){var x=parseFloat(l)*em,S=Math.sin(x),C=Math.cos(x),w;x=parseFloat(u)*em,w=Math.cos(x),a=th(_,a,S*w*-v),o=th(_,o,-Math.sin(x)*-v),s=th(_,s,C*w*-v+v)}h!==ih&&(y+=`perspective(`+h+ah),(r||i)&&(y+=`translate(`+r+`%, `+i+`%) `),(b||a!==ih||o!==ih||s!==ih)&&(y+=s!==ih||b?`translate3d(`+a+`, `+o+`, `+s+`) `:`translate(`+a+`, `+o+ah),c!==rh&&(y+=`rotate(`+c+ah),l!==rh&&(y+=`rotateY(`+l+ah),u!==rh&&(y+=`rotateX(`+u+ah),(d!==rh||f!==rh)&&(y+=`skew(`+d+`, `+f+ah),(p!==1||m!==1)&&(y+=`scale(`+p+`, `+m+ah),_.style[bm]=y||`translate(0, 0)`},sh=function(e,t){var n=t||this,r=n.xPercent,i=n.yPercent,a=n.x,o=n.y,s=n.rotation,c=n.skewX,l=n.skewY,u=n.scaleX,d=n.scaleY,f=n.target,p=n.xOrigin,m=n.yOrigin,h=n.xOffset,g=n.yOffset,_=n.forceCSS,v=parseFloat(a),y=parseFloat(o),b,x,S,C,w;s=parseFloat(s),c=parseFloat(c),l=parseFloat(l),l&&(l=parseFloat(l),c+=l,s+=l),s||c?(s*=em,c*=em,b=Math.cos(s)*u,x=Math.sin(s)*u,S=Math.sin(s-c)*-d,C=Math.cos(s-c)*d,c&&(l*=em,w=Math.tan(c-l),w=Math.sqrt(1+w*w),S*=w,C*=w,l&&(w=Math.tan(l),w=Math.sqrt(1+w*w),b*=w,x*=w)),b=pd(b),x=pd(x),S=pd(S),C=pd(C)):(b=u,C=d,x=S=0),(v&&!~(a+``).indexOf(`px`)||y&&!~(o+``).indexOf(`px`))&&(v=Bm(f,`x`,a,`px`),y=Bm(f,`y`,o,`px`)),(p||m||h||g)&&(v=pd(v+p-(p*b+m*S)+h),y=pd(y+m-(p*x+m*C)+g)),(r||i)&&(w=f.getBBox(),v=pd(v+r/100*w.width),y=pd(y+i/100*w.height)),w=`matrix(`+b+`,`+x+`,`+S+`,`+C+`,`+v+`,`+y+`)`,f.setAttribute(`transform`,w),_&&(f.style[bm]=w)},ch=function(e,t,n,r,i){var a=360,o=bu(i),s=parseFloat(i)*(o&&~i.indexOf(`rad`)?$p:1)-r,c=r+s+`deg`,l,u;return o&&(l=i.split(`_`)[1],l===`short`&&(s%=a,s!==s%(a/2)&&(s+=s<0?a:-a)),l===`cw`&&s<0?s=(s+a*nm)%a-~~(s/a)*a:l===`ccw`&&s>0&&(s=(s-a*nm)%a-~~(s/a)*a)),e._pt=u=new kp(e._pt,t,n,r,s,cm),u.e=c,u.u=`deg`,e._props.push(n),u},lh=function(e,t){for(var n in t)e[n]=t[n];return e},uh=function(e,t,n){var r=lh({},n._gsap),i=`perspective,force3D,transformOrigin,svgOrigin`,a=n.style,o,s,c,l,u,d,f,p;for(s in r.svg?(c=n.getAttribute(`transform`),n.setAttribute(`transform`,``),a[bm]=t,o=$m(n,1),Im(n,bm),n.setAttribute(`transform`,c)):(c=getComputedStyle(n)[bm],a[bm]=t,o=$m(n,1),a[bm]=c),Qp)c=r[s],l=o[s],c!==l&&i.indexOf(s)<0&&(f=nf(c),p=nf(l),u=f===p?parseFloat(c):Bm(n,s,c,p),d=parseFloat(l),e._pt=new kp(e._pt,o,s,u,d-u,sm),e._pt.u=p||0,e._props.push(s));lh(o,r)};fd(`padding,margin,Width,Radius`,function(e,t){var n=`Top`,r=`Right`,i=`Bottom`,a=`Left`,o=(t<3?[n,r,i,a]:[n+a,n+r,i+r,i+a]).map(function(n){return t<2?e+n:`border`+n+e});Km[t>1?`border`+e:e]=function(e,t,n,r,i){var a,s;if(arguments.length<4)return a=o.map(function(t){return Vm(e,t,n)}),s=a.join(` `),s.split(a[0]).length===5?a[0]:s;a=(r+``).split(` `),s={},o.forEach(function(e,t){return s[e]=a[t]=a[t]||a[(t-1)/2|0]}),e.init(t,s,i)}});var dh={name:`css`,register:jm,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,r,i){var a=this._props,o=e.style,s=n.vars.startAt,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;for(m in qp||jm(),this.styles=this.styles||Tm(e),C=this.styles.props,this.tween=n,t)if(m!==`autoRound`&&(l=t[m],!(id[m]&&ap(m,t,n,r,e,i)))){if(f=typeof l,p=Km[m],f===`function`&&(l=l.call(n,r,e,i),f=typeof l),f===`string`&&~l.indexOf(`random(`)&&(l=xf(l)),p)p(this,e,m,l,n)&&(S=1);else if(m.substr(0,2)===`--`)c=(getComputedStyle(e).getPropertyValue(m)+``).trim(),l+=``,If.lastIndex=0,If.test(c)||(h=nf(c),g=nf(l),g?h!==g&&(c=Bm(e,m,c,g)+g):h&&(l+=h)),this.add(o,`setProperty`,c,l,r,i,0,0,m),a.push(m),C.push(m,0,o[m]);else if(f!==`undefined`){if(s&&m in s?(c=typeof s[m]==`function`?s[m].call(n,r,e,i):s[m],bu(c)&&~c.indexOf(`random(`)&&(c=xf(c)),nf(c+``)||c===`auto`||(c+=su.units[m]||nf(Vm(e,m))||``),(c+``).charAt(1)===`=`&&(c=Vm(e,m))):c=Vm(e,m),d=parseFloat(c),_=f===`string`&&l.charAt(1)===`=`&&l.substr(0,2),_&&(l=l.substr(2)),u=parseFloat(l),m in om&&(m===`autoAlpha`&&(d===1&&Vm(e,`visibility`)===`hidden`&&u&&(d=0),C.push(`visibility`,0,o.visibility),Lm(this,o,`visibility`,d?`inherit`:`hidden`,u?`inherit`:`hidden`,!u)),m!==`scale`&&m!==`transform`&&(m=om[m],~m.indexOf(`,`)&&(m=m.split(`,`)[0]))),v=m in Qp,v){if(this.styles.save(m),w=l,f===`string`&&l.substring(0,6)===`var(--`){if(l=Om(e,l.substring(4,l.indexOf(`)`))),l.substring(0,5)===`calc(`){var T=e.style.perspective;e.style.perspective=l,l=Om(e,`perspective`),T?e.style.perspective=T:Im(e,`perspective`)}u=parseFloat(l)}if(y||(b=e._gsap,b.renderTransform&&!t.parseTransform||$m(e,t.parseTransform),x=t.smoothOrigin!==!1&&b.smooth,y=this._pt=new kp(this._pt,o,bm,0,1,b.renderTransform,b,0,-1),y.dep=1),m===`scale`)this._pt=new kp(this._pt,b,`scaleY`,b.scaleY,(_?hd(b.scaleY,_+u):u)-b.scaleY||0,sm),this._pt.u=0,a.push(`scaleY`,m),m+=`X`;else if(m===`transformOrigin`){C.push(xm,0,o[xm]),l=Wm(l),b.svg?Qm(e,l,0,x,0,this):(g=parseFloat(l.split(` `)[2])||0,g!==b.zOrigin&&Lm(this,b,`zOrigin`,b.zOrigin,g),Lm(this,o,m,eh(c),eh(l)));continue}else if(m===`svgOrigin`){Qm(e,l,1,x,0,this);continue}else if(m in Jm){ch(this,b,m,d,_?hd(d,_+l):l);continue}else if(m===`smoothOrigin`){Lm(this,b,`smooth`,b.smooth,l);continue}else if(m===`force3D`){b[m]=l;continue}else if(m===`transform`){uh(this,l,e);continue}}else m in o||(m=Am(m)||m);if(v||(u||u===0)&&(d||d===0)&&!am.test(l)&&m in o)h=(c+``).substr((d+``).length),u||=0,g=nf(l)||(m in su.units?su.units[m]:h),h!==g&&(d=Bm(e,m,c,g)),this._pt=new kp(this._pt,v?b:o,m,d,(_?hd(d,_+u):u)-d,!v&&(g===`px`||m===`zIndex`)&&t.autoRound!==!1?dm:sm),this._pt.u=g||0,v&&w!==l?(this._pt.b=c,this._pt.e=w,this._pt.r=um):h!==g&&g!==`%`&&(this._pt.b=c,this._pt.r=lm);else if(m in o)Hm.call(this,e,m,c,_?_+l:l);else if(m in e)this.add(e,m,c||e[m],_?_+l:l,r,i);else if(m!==`parseTransform`){qu(m,l);continue}v||(m in o?C.push(m,0,o[m]):typeof e[m]==`function`?C.push(m,2,e[m]()):C.push(m,1,c||e[m])),a.push(m)}}S&&Op(this)},render:function(e,t){if(t.tween._time||!Xp())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Vm,aliases:om,getSetter:function(e,t,n){var r=om[t];return r&&r.indexOf(`,`)<0&&(t=r),t in Qp&&t!==xm&&(e._gsap.x||Vm(e,`x`))?n&&Yp===n?t===`scale`?_m:gm:(Yp=n||{})&&(t===`scale`?vm:ym):e.style&&!Cu(e.style[t])?mm:~t.indexOf(`-`)?hm:bp(e,t)},core:{_removeProperty:Im,_getMatrix:Zm}};Up.utils.checkPrefix=Am,Up.core.getStyleSaver=Tm,(function(e,t,n,r){var i=fd(e+`,`+t+`,`+n,function(e){Qp[e]=1});fd(t,function(e){su.units[e]=`deg`,Jm[e]=1}),om[i[13]]=e+`,`+t,fd(r,function(e){var t=e.split(`:`);om[t[1]]=i[t[0]]})})(`x,y,z,scale,scaleX,scaleY,xPercent,yPercent`,`rotation,rotationX,rotationY,skewX,skewY`,`transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective`,`0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY`),fd(`x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective`,function(e){su.units[e]=`px`}),Up.registerPlugin(dh);var fh=Up.registerPlugin(dh)||Up;fh.core.Tween;function ph(e,t){document.getElementById(`align-view`).addEventListener(`click`,()=>{fh.to(e.position,{x:0,y:20,z:.1,duration:1,ease:`power2.inOut`,onUpdate:()=>e.lookAt(0,0,0)}),fh.to(t.target,{x:0,y:0,z:0,duration:1,ease:`power2.inOut`})})}function mh(){let e=new jn,t=new ma(75,window.innerWidth/window.innerHeight,.1,1e3);t.position.z=15;let n=new ol({canvas:document.getElementById(`app`),antialias:!0,alpha:!0});n.setSize(window.innerWidth,window.innerHeight),e.add(new va(16777215,.6));let r=new _a(16777215,.8);r.position.set(10,20,10),e.add(r);let i=[],a=[`1x1 Brick`,`1x2 Brick`,`2x4 Brick`];for(let t=0;t<20;t++){let t=a[Math.floor(Math.random()*a.length)],n=Fl(t);n.position.set((Math.random()-.5)*30,(Math.random()-.5)*30,(Math.random()-.5)*30),n.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),e.add(n),i.push({mesh:n,rotSpeed:{x:(Math.random()-.5)*.02,y:(Math.random()-.5)*.02,z:(Math.random()-.5)*.02},floatSpeed:Math.random()*.005+.002,floatOffset:Math.random()*Math.PI*2})}let o;function s(){o=requestAnimationFrame(s),i.forEach(e=>{e.mesh.rotation.x+=e.rotSpeed.x,e.mesh.rotation.y+=e.rotSpeed.y,e.mesh.rotation.z+=e.rotSpeed.z,e.mesh.position.y+=Math.sin(Date.now()*e.floatSpeed+e.floatOffset)*.01}),n.render(e,t)}return s(),{stop:()=>cancelAnimationFrame(o),resize:()=>{t.aspect=window.innerWidth/window.innerHeight,t.updateProjectionMatrix(),n.setSize(window.innerWidth,window.innerHeight)}}}function hh(e,t={}){let{head:n=`#ffff00`,torso:r=`#ff0000`,legs:i=`#0000ff`,faceType:a=`classic`,gender:o=`male`}=t,s=new Cn;s.name=`Avatar`,s.userData.height=2.4;let c=new Ti(.4,.4,.8,16),l=new Li({color:n}),u=new Li({map:gh(a,o),transparent:!0,color:n}),d=new Jr(c,[l,l,l]),f=new Jr(new Ei(.5,.5),u);f.position.set(0,0,.41),d.add(f),d.position.y=1.6,s.add(d);let p=new Jr(new wi(.8,.8,.4),new Li({color:r}));p.position.y=.8,s.add(p);let m=new wi(.35,.8,.35),h=new Li({color:i}),g=new Jr(m,h);g.position.set(-.2,0,0),s.add(g);let _=new Jr(m,h);return _.position.set(.2,0,0),s.add(_),s}function gh(e,t){let n=document.createElement(`canvas`);n.width=128,n.height=128;let r=n.getContext(`2d`);switch(r.strokeStyle=`#000`,r.lineWidth=8,r.lineCap=`round`,t===`female`&&(r.lineWidth=4,r.beginPath(),r.moveTo(30,40),r.lineTo(20,30),r.moveTo(40,35),r.lineTo(40,25),r.stroke(),r.beginPath(),r.moveTo(98,40),r.lineTo(108,30),r.moveTo(88,35),r.lineTo(88,25),r.stroke(),r.lineWidth=8),e){case`cool`:r.fillStyle=`#000`,r.fillRect(20,40,35,20),r.fillRect(73,40,35,20),r.beginPath(),r.moveTo(55,50),r.lineTo(73,50),r.stroke(),r.beginPath(),r.arc(64,80,25,0,Math.PI),r.stroke();break;case`surprised`:r.strokeRect(35,40,10,10),r.strokeRect(83,40,10,10),r.beginPath(),r.arc(64,90,15,0,Math.PI*2),r.stroke();break;case`wink`:r.strokeRect(35,40,10,10),r.beginPath(),r.moveTo(80,45),r.lineTo(100,45),r.stroke(),r.beginPath(),r.arc(64,80,25,0,Math.PI),r.stroke();break;default:r.fillStyle=`#000`,r.beginPath(),r.arc(40,50,6,0,Math.PI*2),r.fill(),r.beginPath(),r.arc(88,50,6,0,Math.PI*2),r.fill(),r.beginPath(),r.arc(64,75,30,.2*Math.PI,.8*Math.PI),r.stroke()}return new bi(n)}var _h=`briccd_save_data`;function vh(e,t){let n=t.map(e=>({type:e.name,position:e.position.toArray(),rotation:e.rotation.toArray().slice(0,3),color:e.children[0].material.color.getHex(),userData:e.userData}));localStorage.setItem(_h,JSON.stringify(n)),console.log(`Saved to local device`)}function yh(e,t){let n=localStorage.getItem(_h);return n?(JSON.parse(n).forEach(n=>{let r=Fl(n.type);r&&(r.position.fromArray(n.position),r.rotation.fromArray([...n.rotation,`XYZ`]),n.color&&r.traverse(e=>{e.isMesh&&e.material.color.setHex(n.color)}),e.add(r),t(r))}),!0):!1}var bh=document.getElementById(`landing-overlay`),xh=document.getElementById(`start-btn`),Sh=document.getElementById(`toolbox`),Ch=document.getElementById(`profile-ui`),wh=document.getElementById(`movement-controls`),Th=document.getElementById(`unhide-ui`),Eh=!1,Dh=mh();xh.addEventListener(`click`,()=>{Oh()});function Oh(){Eh||(Dh.stop(),bh.classList.add(`hidden`),Sh.classList.remove(`hidden`),Eh=!0,kh())}document.getElementById(`open-profile`).addEventListener(`click`,()=>Ch.classList.remove(`hidden`)),document.getElementById(`close-profile`).addEventListener(`click`,()=>Ch.classList.add(`hidden`)),window.addEventListener(`resize`,()=>{Eh||Dh.resize()});function kh(){let e=new jn;e.background=new X(8900331);let t=new ma(75,window.innerWidth/window.innerHeight,.1,1e3);t.position.set(10,10,10);let n=new ol({canvas:document.getElementById(`app`),antialias:!0});n.setSize(window.innerWidth,window.innerHeight),n.setPixelRatio(window.devicePixelRatio),n.xr.enabled=!0,document.getElementById(`vr-controls`).appendChild(Al.createButton(n));let r=new _l(t,n.domElement);r.enableDamping=!0;let i=new Ba(20,20,0,4473924);e.add(i);let a=new Jr(new Ei(20,20),new Li({color:2263842}));a.rotation.x=-Math.PI/2,a.position.y=-.01,e.add(a),e.add(new va(16777215,.6));let o=new _a(16777215,.8);o.position.set(10,20,10),e.add(o);let s=ru(t,n,e,r);iu(t,e,s.getDraggables,s.removeDraggable),ph(t,r);let c=null;document.getElementById(`hide-ui`).addEventListener(`click`,()=>{Sh.classList.add(`hidden`),wh.classList.add(`hidden`),Th.classList.remove(`hidden`)}),Th.addEventListener(`click`,()=>{Sh.classList.remove(`hidden`),c&&wh.classList.remove(`hidden`),Th.classList.add(`hidden`)}),document.getElementById(`toggle-fullscreen`).addEventListener(`click`,()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(e=>{console.error(`Error attempting to enable full-screen mode: ${e.message}`)})}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&(document.fullscreenElement&&document.exitFullscreen(),Sh.classList.contains(`hidden`)&&(Sh.classList.remove(`hidden`),c&&wh.classList.remove(`hidden`),Th.classList.add(`hidden`)))});let l=hh(e);l.position.set(-5,1.2,-5),e.add(l),s.addDraggable(l),document.getElementById(`save-avatar`).addEventListener(`click`,()=>{s.removeDraggable(l),e.remove(l),l=hh(e,{head:document.getElementById(`head-color`).value,torso:document.getElementById(`torso-color`).value,legs:document.getElementById(`legs-color`).value,faceType:document.getElementById(`face-type`).value,gender:document.getElementById(`gender-type`).value}),l.position.set(-5,1.2,-5),e.add(l),s.addDraggable(l),Ch.classList.add(`hidden`)}),Il(e,t=>{let n=Fl(t);n.position.set(0,n.userData.height/2,0),e.add(n),s.addDraggable(n),c=n,Sh.classList.contains(`hidden`)||wh.classList.remove(`hidden`)}),document.getElementById(`save-local`).addEventListener(`click`,()=>{vh(e,s.getDraggables())}),document.getElementById(`load-local`).addEventListener(`click`,()=>{yh(e,s.addDraggable)}),document.getElementById(`rotate-piece`).addEventListener(`click`,()=>{c&&(c.rotation.y+=Math.PI/2)}),document.getElementById(`lift-piece`).addEventListener(`click`,()=>{c&&(c.position.y+=jl)}),document.getElementById(`drop-piece`).addEventListener(`click`,()=>{if(c){let e=c.userData.height||.4;c.position.y=e/2}});let u=(e,t,n)=>{if(c){c.position.x+=e*1,c.position.y+=t*jl,c.position.z+=n*1,c.position.x=Math.round(c.position.x/1)*1,c.position.z=Math.round(c.position.z/1)*1;let r=c.userData.height||.4;c.position.y=Math.max(r/2,Math.round((c.position.y-r/2)/jl)*jl+r/2)}};document.getElementById(`move-fwd`).addEventListener(`click`,()=>u(0,0,-1)),document.getElementById(`move-back`).addEventListener(`click`,()=>u(0,0,1)),document.getElementById(`move-left`).addEventListener(`click`,()=>u(-1,0,0)),document.getElementById(`move-right`).addEventListener(`click`,()=>u(1,0,0)),document.getElementById(`move-up`).addEventListener(`click`,()=>u(0,1,0)),document.getElementById(`move-down`).addEventListener(`click`,()=>u(0,-1,0)),window.addEventListener(`mousedown`,n=>{let r=new Ia,i=new K;i.x=n.clientX/window.innerWidth*2-1,i.y=-(n.clientY/window.innerHeight)*2+1,r.setFromCamera(i,t);let a=r.intersectObjects(s.getDraggables(),!0);if(a.length>0){let t=a[0].object;for(;t.parent&&t.parent!==e;)t=t.parent;if(n.ctrlKey||n.metaKey){let n=t.clone();n.position.y+=jl,e.add(n),s.addDraggable(n),c=n,Sh.classList.contains(`hidden`)||wh.classList.remove(`hidden`)}else c=t,Sh.classList.contains(`hidden`)||wh.classList.remove(`hidden`)}}),n.setAnimationLoop(()=>{r.update(),n.render(e,t)}),window.addEventListener(`resize`,()=>{t.aspect=window.innerWidth/window.innerHeight,t.updateProjectionMatrix(),n.setSize(window.innerWidth,window.innerHeight)})}